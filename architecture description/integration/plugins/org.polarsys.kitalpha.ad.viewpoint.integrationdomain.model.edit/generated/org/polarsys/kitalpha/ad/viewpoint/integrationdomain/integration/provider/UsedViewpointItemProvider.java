 ...
 * @generated
 */
public class UsedViewpointItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addVpIdPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_UsedViewpoint_vpId_feature"), getString("_UI_PropertyDescriptor_description", "_UI_UsedViewpoint_vpId_feature", "_UI_UsedViewpoint_type"), IntegrationPackage.Literals.USED_VIEWPOINT__VP_ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	...
	protected void addVersionPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_UsedViewpoint_version_feature"), getString("_UI_PropertyDescriptor_description", "_UI_UsedViewpoint_version_feature", "_UI_UsedViewpoint_type"), IntegrationPackage.Literals.USED_VIEWPOINT__VERSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	...
	protected void addFilteredPropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_UsedViewpoint_filtered_feature"), getString("_UI_PropertyDescriptor_description", "_UI_UsedViewpoint_filtered_feature", "_UI_UsedViewpoint_type"), IntegrationPackage.Literals.USED_VIEWPOINT__FILTERED, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));

	}

	/**
	 * This returns UsedViewpoint.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_UsedViewpoint_type") : getString("_UI_UsedViewpoint_type") + " " + label;
