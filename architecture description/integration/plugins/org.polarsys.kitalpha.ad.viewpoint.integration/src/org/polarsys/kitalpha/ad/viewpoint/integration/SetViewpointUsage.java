 ...
 * 
 */
public class SetViewpointUsage extends RecordingCommand {

	private Integration integration;
	private String vpid;
	private boolean usage;

	public SetViewpointUsage(TransactionalEditingDomain domain, Integration integration, String vpid, boolean usage) {
		super(domain);
