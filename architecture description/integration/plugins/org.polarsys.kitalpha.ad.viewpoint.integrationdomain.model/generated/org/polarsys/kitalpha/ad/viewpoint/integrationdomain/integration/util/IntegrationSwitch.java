...
package org.polarsys.kitalpha.ad.viewpoint.integrationdomain.integration.util;
...
public class IntegrationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case IntegrationPackage.INTEGRATION: {
		...
		case IntegrationPackage.USED_VIEWPOINT: {
			UsedViewpoint usedViewpoint = (UsedViewpoint) theEObject;
			T result = caseUsedViewpoint(usedViewpoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * <em>Integration</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Used Viewpoint</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '
	 *         <em>Used Viewpoint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUsedViewpoint(UsedViewpoint object) {
		return null;
	}
