...
public class VpspecGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ViewpointElements extends AbstractParserRuleElementFinder {
		...
		//	VP_Aspects+=[vpdiagram::DiagramSet|FQN])? (type+="Services" VP_Aspects+=[vpservices::ServiceSet|FQN])?
		//	//[services::Services | FQN])?
		// (type+="Build" VP_Aspects+=[vpbuild::Build|FQN])? (type+="Configuration"
