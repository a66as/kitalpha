		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocalClassAssociationAccess().getChangeableAssignment_6_0_1(), "rule__LocalClassAssociation__ChangeableAssignment_6_0_1");
					put(grammarAccess.getLocalClassAssociationAccess().getDerivedAssignment_6_1_1(), "rule__LocalClassAssociation__DerivedAssignment_6_1_1");
					put(grammarAccess.getLocalClassAssociationAccess().getOrderedAssignment_6_2_1(), "rule__LocalClassAssociation__OrderedAssignment_6_2_1");
					put(grammarAccess.getLocalClassAssociationAccess().getTransientAssignment_6_3_1(), "rule__LocalClassAssociation__TransientAssignment_6_3_1");
					put(grammarAccess.getLocalClassAssociationAccess().getUniqueAssignment_6_4_1(), "rule__LocalClassAssociation__UniqueAssignment_6_4_1");
					put(grammarAccess.getLocalClassAssociationAccess().getUnsettableAssignment_6_5_1(), "rule__LocalClassAssociation__UnsettableAssignment_6_5_1");
					put(grammarAccess.getLocalClassAssociationAccess().getVolatileAssignment_6_6_1(), "rule__LocalClassAssociation__VolatileAssignment_6_6_1");
