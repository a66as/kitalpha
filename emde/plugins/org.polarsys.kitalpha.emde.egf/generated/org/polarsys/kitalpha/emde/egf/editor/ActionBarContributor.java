...
public class ActionBarContributor extends org.eclipse.egf.emf.pattern.editor.ActionBarContributor {
	...
	protected final String TEXT_15 = " dialog = new LoadingResourceReuseDialog(activeEditor.getSite().getShell());" + NL
			+ "\t\t\t\t" + NL + "\t\t\t\tEObject selection = currentResource.getContents().get(0);" + NL
			+ "\t\t\t\tdialog.setSelection(selection);" + NL + "\t\t\t\tdialog.open();" + NL + "\t\t\t\t" + NL
			+ "\t\t\t\t";
	protected final String TEXT_16 = " context = ModelReuseContext.INSTANCE;" + NL + "\t\t\t\tList<";
	protected final String TEXT_17 = "> criterias = context.getCriterias();" + NL
			+ "\t\t\t\tfor (SearchCriteria settedCriteria : criterias) {" + NL
			+ "\t\t\t\t\tjava.util.List<URI> modelToLoad = ";
	protected final String TEXT_18 = ".findModelsURIAccordingToCriteria(settedCriteria);" + NL + "\t\t\t\t\t";
	protected final String TEXT_19 = ".loadResourceForCurrentRessourceSet(selection, modelToLoad);" + NL
			+ "\t\t\t\t\tmodelToLoad = ModelReuseHelper.findMetadataURIAccordingToCriteria(settedCriteria);" + NL
			+ "\t\t\t\t\tResourceSetLoaderServices.loadResourceForCurrentRessourceSet(selection, modelToLoad);" + NL
			+ "\t\t\t\t\tfor (URI uri: modelToLoad)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
	protected final String TEXT_20 = ".add(currentResource.getResourceSet(), currentResource.getURI(), uri);" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL
			+ "\tprivate final class RefreshViewerAction extends ";
	...
	protected final String TEXT_60 = NL + "\t\t\t\tsetFilter(\"*\");" + NL + "\t\t\t\t";
	protected final String TEXT_61 = "<String, ";
	protected final String TEXT_62 = "> ePackageNsURItoGenModelLocationMap = ";
	protected final String TEXT_63 = ".getEPackageNsURIToGenModelLocationMap();" + NL
			+ "\t\t\t\tObject [] result = ePackageNsURItoGenModelLocationMap.keySet().toArray(new Object[ePackageNsURItoGenModelLocationMap.size()]);"
			+ NL + "\t\t\t\t";
	protected final String TEXT_64 = ".sort(result);" + NL + "\t\t\t\tsetElements(result);" + NL
			+ "\t\t\t\tsetTitle(EcoreEditorPlugin.INSTANCE.getString(\"_UI_PackageSelection_label\"));";
	protected final String TEXT_65 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "    " + NL + "\t}" + NL;
	protected final String TEXT_66 = NL + "\t/**" + NL + "\t * Action to create objects from the ";
	protected final String TEXT_67 = " model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->"
	...
	protected final String TEXT_68 = NL + "\t{" + NL + "\t\t/**" + NL
			...
			+ "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic void run(";
	protected final String TEXT_69 = " action)" + NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_70 = " wizard = new ";
	protected final String TEXT_71 = "();" + NL + "\t\t\twizard.init(getWindow().getWorkbench(), ";
	protected final String TEXT_72 = ".EMPTY);" + NL + "\t\t\t";
	protected final String TEXT_73 = " wizardDialog = new ";
	protected final String TEXT_74 = "(getWindow().getShell(), wizard);" + NL + "\t\t\twizardDialog.open();" + NL
			+ "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_75 = NL + "\t/**" + NL + "\t * This keeps track of the active editor." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tprotected ";
	protected final String TEXT_76 = " activeEditorPart;" + NL + "" + NL + "\t/**" + NL
			+ "\t * This keeps track of the current selection provider." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_77 = " selectionProvider;" + NL + "" + NL + "\t/**" + NL
			+ "\t * This action opens the Properties view." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_78 = " showPropertiesViewAction = new ShowPropertiesViewAction();" + NL + "\t" + NL
			...
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tprotected ";
	protected final String TEXT_79 = " refreshViewerAction = new RefreshViewerAction();" + NL + "\t" + NL + "\t/**" + NL
			+ "\t * This action load resource from resourcereuse/emfscheme" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_80 = " schemeLoadResourceAction = new SchemeLoadResourceAction();" + NL + "\t";
	protected final String TEXT_81 = NL + "\t/**" + NL
			+ "\t * This will contain one {@link org.eclipse.emf.edit.ui.action.CreateChildAction} corresponding to each descriptor"
			+ NL + "\t * generated for the current selection by the item provider." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tprotected ";
	protected final String TEXT_82 = " createChildActions;" + NL;
	protected final String TEXT_83 = NL + "\t/**" + NL
			...
			+ "\t */" + NL + "\tprotected ";
	protected final String TEXT_84 = " createChildSubmenuActions;" + NL;
	protected final String TEXT_85 = NL + "\t/**" + NL
			+ "\t * This is the menu manager into which menu contribution items should be added for CreateChild actions."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	protected final String TEXT_86 = " createChildMenuManager;" + NL + "" + NL + "\t/**" + NL
			+ "\t * This will contain one {@link org.eclipse.emf.edit.ui.action.CreateSiblingAction} corresponding to each descriptor"
			+ NL + "\t * generated for the current selection by the item provider." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tprotected ";
	protected final String TEXT_87 = " createSiblingActions;" + NL;
	protected final String TEXT_88 = NL + "\t/**" + NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	protected final String TEXT_89 = " createSiblingSubmenuActions;" + NL;
	protected final String TEXT_90 = NL + "\t/**" + NL
			+ "\t * This is the menu manager into which menu contribution items should be added for CreateSibling actions."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	protected final String TEXT_91 = " createSiblingMenuManager;" + NL;
	...
	protected final String TEXT_94 = "> currentResourceEmdeViewerFilterActions;\t" + NL + "\t" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */    " + NL + "\tprotected ";
	protected final String TEXT_95 = " extensionViewerFilterMenuManager;\t" + NL + "  " + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */    " + NL + "\tprotected ";
	protected final String TEXT_96 = " currentResource;" + NL + "\t";
	protected final String TEXT_97 = NL + "\t/**" + NL + "\t * This creates an instance of the contributor." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tpublic ";
	protected final String TEXT_98 = "()" + NL + "\t{" + NL + "\t\tsuper(ADDITIONS_LAST_STYLE);" + NL
			+ "\t\tloadResourceAction = new ExtendedLoadResourceAction();" + NL + "\t\tvalidateAction = new ";
	protected final String TEXT_99 = "();" + NL + "\t\tcontrolAction = new ";
	...
	protected final String TEXT_102 = " event) {" + NL + "\t\tif (event.getSource() instanceof ";
	protected final String TEXT_103 = ") {" + NL + "\t\t\t// Fake a selection changed event to update the menus." + NL
	...
	protected final String TEXT_106 = NL + "\tpublic void contributeToToolBar(";
	protected final String TEXT_107 = " toolBarManager)" + NL + "\t{" + NL + "\t\ttoolBarManager.add(new ";
	protected final String TEXT_108 = "(\"";
	protected final String TEXT_109 = "-settings\"));";
	protected final String TEXT_110 = NL + "\t\ttoolBarManager.add(new ";
	protected final String TEXT_111 = "(\"";
	protected final String TEXT_112 = "-additions\"));";
	...
	protected final String TEXT_115 = NL + "\tpublic void contributeToMenu(";
	protected final String TEXT_116 = " menuManager)" + NL + "\t{" + NL + "\t\tsuper.contributeToMenu(menuManager);"
			+ NL + "" + NL + "\t\t";
	protected final String TEXT_117 = " submenuManager = new ";
	protected final String TEXT_118 = "(";
	protected final String TEXT_119 = ".INSTANCE.getString(\"_UI_";
	protected final String TEXT_120 = "_menu\"), \"";
	protected final String TEXT_121 = "MenuID\");";
	protected final String TEXT_122 = NL + "\t\tmenuManager.insertAfter(\"additions\", submenuManager);";
	protected final String TEXT_123 = NL + "\t\tsubmenuManager.add(new ";
	protected final String TEXT_124 = "(\"settings\"));";
	protected final String TEXT_125 = NL + "\t\tsubmenuManager.add(new ";
	protected final String TEXT_126 = "(\"actions\"));";
	protected final String TEXT_127 = NL + "\t\tsubmenuManager.add(new ";
	protected final String TEXT_128 = "(\"additions\"));";
	protected final String TEXT_129 = NL + "\t\tsubmenuManager.add(new ";
	protected final String TEXT_130 = "(\"additions-end\"));";
	protected final String TEXT_131 = NL + "\t\t";
	protected final String TEXT_132 = NL + "\t\t// Prepare Model Extension Menu Manager" + NL
			+ "\t\textensionViewerFilterMenuManager = new MenuManager(";
	protected final String TEXT_133 = "._UI_Model_Extensions);" + NL
			+ "\t\tsubmenuManager.insertBefore(\"additions-end\", extensionViewerFilterMenuManager);";
	protected final String TEXT_134 = NL + "\t\tsubmenuManager.insertBefore(\"additions-end\", new ";
	protected final String TEXT_135 = "());";
	protected final String TEXT_136 = NL + "\t\t    ";
	protected final String TEXT_137 = "\t\t";
	protected final String TEXT_138 = NL + "\t\t// Prepare for CreateChild item addition or removal." + NL + "\t\t//"
			+ NL + "\t\tcreateChildMenuManager = new ";
	protected final String TEXT_139 = "(";
	protected final String TEXT_140 = ".INSTANCE.getString(\"_UI_CreateChild_menu_item\"));";
	protected final String TEXT_141 = NL + "\t\tsubmenuManager.insertBefore(\"additions\", createChildMenuManager);";
	protected final String TEXT_142 = NL + NL + "\t\t// Prepare for CreateSibling item addition or removal." + NL
			+ "\t\t//" + NL + "\t\tcreateSiblingMenuManager = new ";
	protected final String TEXT_143 = "(";
	protected final String TEXT_144 = ".INSTANCE.getString(\"_UI_CreateSibling_menu_item\"));";
	protected final String TEXT_145 = NL + "\t\tsubmenuManager.insertBefore(\"additions\", createSiblingMenuManager);";
	protected final String TEXT_146 = NL + NL + "\t\t// Force an update because Eclipse hides empty menus now." + NL
			+ "\t\t//" + NL + "\t\tsubmenuManager.addMenuListener" + NL + "\t\t\t(new ";
	protected final String TEXT_147 = "()" + NL + "\t\t\t {" + NL + "\t\t\t\t public void menuAboutToShow(";
	protected final String TEXT_148 = " menuManager)" + NL + "\t\t\t\t {" + NL
			+ "\t\t\t\t\t menuManager.updateAll(true);" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
	protected final String TEXT_149 = NL + "\t\t// Add your contributions." + NL
			+ "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL;
	protected final String TEXT_150 = NL + "\t\taddGlobalActions(submenuManager);" + NL + "\t}" + NL + "" + NL + "\t/**"
			+ NL
			+ "\t * When the active editor changes, this remembers the change and registers with it as a selection provider."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_151 = NL + "\t@Override";
	protected final String TEXT_152 = NL + "\tpublic void setActiveEditor(";
	protected final String TEXT_153 = " part)" + NL + "\t{" + NL + "\t\tsuper.setActiveEditor(part);" + NL
			+ "\t\tactiveEditorPart = part;" + NL;
	protected final String TEXT_154 = NL + NL + "\t\tif (part instanceof ";
	protected final String TEXT_155 = " == false) {" + NL
			+ "\t\t\tif (currentResourceEmdeViewerFilterActions != null) {" + NL + "\t\t\t\tfor (";
	protected final String TEXT_156 = " filterAction : currentResourceEmdeViewerFilterActions) {      " + NL
			+ "\t\t\t\t\tfilterAction.setEnabled(false);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_157 = NL + NL + "\t\t// Switch to the new selection provider." + NL + "\t\t//" + NL
	...
	protected final String TEXT_158 = "(selectionProvider, selectionProvider.getSelection()));" + NL + "\t\t\t}" + NL
			+ "\t\t}" + NL + "\t}";
	...
	protected final String TEXT_161 = NL + "\tpublic void dispose() {" + NL + "\t\tsuper.dispose();";
	protected final String TEXT_162 = NL + "\t\tif (currentResourceEmdeViewerFilterActions != null) {" + NL
	...
	protected final String TEXT_165 = " event)" + NL + "\t{" + NL + "\t\t// Current Selection" + NL + "\t\t";
	protected final String TEXT_166 = " selection = event.getSelection();" + NL + "\t\tObject selectedObject = null;"
			+ NL + "\t\tif (selection instanceof ";
	protected final String TEXT_167 = " && ((IStructuredSelection) selection).size() == 1) {" + NL
			+ "\t\t\tselectedObject = ((";
	protected final String TEXT_168 = ") selection).getFirstElement();" + NL + "\t\t}" + NL + "\t\t\t";
	protected final String TEXT_169 = NL + "\t\t";
	protected final String TEXT_170 = " resource = null;" + NL + "\t\tif (selectedObject instanceof ";
	protected final String TEXT_171 = ") {" + NL + "\t\t\tresource = ((";
	protected final String TEXT_172 = ") selectedObject).eResource();" + NL
			+ "\t\t} else if (selectedObject instanceof ";
	protected final String TEXT_173 = ") {" + NL + "\t\t\tresource = (";
	protected final String TEXT_174 = ") selectedObject;" + NL + "\t\t}" + NL + "\t\tif (resource != null) {" + NL
	...
	protected final String TEXT_176 = NL + "\t\t// Remove any menu items for old selection." + NL + "\t\t//" + NL
			+ "\t\tif (createChildMenuManager != null)" + NL + "\t\t{";
	protected final String TEXT_177 = NL
			+ "\t\t\tdepopulateManager(createChildMenuManager, createChildSubmenuActions);";
	protected final String TEXT_178 = NL + "\t\t\tdepopulateManager(createChildMenuManager, createChildActions);" + NL
			+ "\t\t}" + NL + "\t\tif (createSiblingMenuManager != null)" + NL + "\t\t{";
	protected final String TEXT_179 = NL
			+ "\t\t\tdepopulateManager(createSiblingMenuManager, createSiblingSubmenuActions);";
	protected final String TEXT_180 = NL + "\t\t\tdepopulateManager(createSiblingMenuManager, createSiblingActions);"
			+ NL + "\t\t}";
	protected final String TEXT_181 = NL + NL + "\t\t// Populate EmdeViewerFilterActions if necessary" + NL
			+ "\t\tif (currentResourceEmdeViewerFilterActions == null) {" + NL
			+ "\t\t\tcurrentResourceEmdeViewerFilterActions = ((";
	protected final String TEXT_182 = ") activeEditorPart).getEmdeViewerFilterActions(currentResource);" + NL
			+ "\t\t\tif (extensionViewerFilterMenuManager != null) {" + NL
	...
	protected final String TEXT_185 = " newSiblingDescriptors = null;" + NL + "" + NL
			+ "\t\tif (selectedObject != null)" + NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_186 = " domain = ((";
	protected final String TEXT_187 = ")activeEditorPart).getEditingDomain();" + NL + "" + NL
	...
	protected final String TEXT_193 = NL + "\t\t\tpopulateManager(createChildMenuManager, createChildActions, null);"
	...
	protected final String TEXT_196 = NL + "\t\t// Add your contributions." + NL
	...
	protected final String TEXT_198 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_199 = " generateCreateChildActions(";
	protected final String TEXT_200 = " descriptors, ";
	protected final String TEXT_201 = " selection)" + NL + "\t{" + NL + "\t\t";
	protected final String TEXT_202 = " actions = new ";
	protected final String TEXT_203 = "();" + NL + "\t\tif (descriptors != null)" + NL + "\t\t{";
	protected final String TEXT_204 = NL + "\t\t\tfor (";
	protected final String TEXT_205 = " descriptor : descriptors)";
	protected final String TEXT_206 = NL + "\t\t\tfor (";
	protected final String TEXT_207 = " i = descriptors.iterator(); i.hasNext(); )";
	protected final String TEXT_208 = NL + "\t\t\t{" + NL + "\t\t\t\tactions.add(new ";
	protected final String TEXT_209 = "(activeEditorPart, selection, ";
	protected final String TEXT_210 = "descriptor";
	protected final String TEXT_211 = "i.next()";
	protected final String TEXT_212 = "));" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn actions;" + NL + "\t}"
			+ NL + "" + NL + "\t/**" + NL
			+ "\t * This generates a {@link org.eclipse.emf.edit.ui.action.CreateSiblingAction} for each object in <code>descriptors</code>,"
			+ NL + "\t * and returns the collection of these actions." + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_213 = " generateCreateSiblingActions(";
	protected final String TEXT_214 = " descriptors, ";
	protected final String TEXT_215 = " selection)" + NL + "\t{" + NL + "\t\t";
	protected final String TEXT_216 = " actions = new ";
	protected final String TEXT_217 = "();" + NL + "\t\tif (descriptors != null)" + NL + "\t\t{";
	protected final String TEXT_218 = NL + "\t\t\tfor (";
	protected final String TEXT_219 = " descriptor : descriptors)";
	protected final String TEXT_220 = NL + "\t\t\tfor (";
	protected final String TEXT_221 = " i = descriptors.iterator(); i.hasNext(); )";
	protected final String TEXT_222 = NL + "\t\t\t{" + NL + "\t\t\t\tactions.add(new ";
	protected final String TEXT_223 = "(activeEditorPart, selection, ";
	protected final String TEXT_224 = "descriptor";
	protected final String TEXT_225 = "i.next()";
	protected final String TEXT_226 = "));" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\treturn actions;" + NL + "\t}"
			+ NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_228 = " actions, String contributionID)" + NL + "\t{" + NL + "\t\tif (actions != null)"
			+ NL + "\t\t{";
	protected final String TEXT_229 = NL + "\t\t\tfor (";
	protected final String TEXT_230 = " action : actions)";
	protected final String TEXT_231 = NL + "\t\t\tfor (";
	protected final String TEXT_232 = " i = actions.iterator(); i.hasNext(); )";
	protected final String TEXT_233 = NL + "\t\t\t{";
	protected final String TEXT_234 = NL + "\t\t\t\t";
	protected final String TEXT_235 = " action = (IAction)i.next();";
	protected final String TEXT_236 = NL + "\t\t\t\tif (contributionID != null)" + NL + "\t\t\t\t{" + NL
	...
	protected final String TEXT_238 = " actions)" + NL + "\t{" + NL + "\t\tif (actions != null)" + NL + "\t\t{" + NL
			+ "\t\t\t";
	protected final String TEXT_239 = "[] items = manager.getItems();" + NL
			+ "\t\t\tfor (int i = 0; i < items.length; i++)" + NL + "\t\t\t{" + NL
			+ "\t\t\t\t// Look into SubContributionItems" + NL + "\t\t\t\t//" + NL + "\t\t\t\t";
	protected final String TEXT_240 = " contributionItem = items[i];" + NL
			+ "\t\t\t\twhile (contributionItem instanceof ";
	protected final String TEXT_241 = ")" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tcontributionItem = ((";
	protected final String TEXT_242 = ")contributionItem).getInnerItem();" + NL + "\t\t\t\t}" + NL + "" + NL
	...
	protected final String TEXT_244 = " action = ((";
	protected final String TEXT_245 = ")contributionItem).getAction();" + NL + "\t\t\t\t\tif (actions.contains(action))"
	...
	protected final String TEXT_246 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
	protected final String TEXT_247 = " extractSubmenuActions(";
	protected final String TEXT_248 = " createActions)" + NL + "\t{" + NL + "\t\t";
	protected final String TEXT_249 = " createSubmenuActions = new ";
	protected final String TEXT_250 = "();" + NL + "\t\tif (createActions != null)" + NL + "\t\t{" + NL + "\t\t\tfor (";
	protected final String TEXT_251 = " actions = createActions.iterator(); actions.hasNext(); )" + NL + "\t\t\t{" + NL
			+ "\t\t\t\t";
	protected final String TEXT_252 = " action = ";
	protected final String TEXT_253 = "(";
	protected final String TEXT_254 = ")";
	protected final String TEXT_255 = "actions.next();" + NL + "\t\t\t\t";
	protected final String TEXT_256 = " st = new ";
	protected final String TEXT_257 = "(action.getText(), \"|\");";
	protected final String TEXT_258 = NL + "\t\t\t\tif (st.countTokens() == 2)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tString text = st.nextToken().trim();" + NL + "\t\t\t\t\t";
	protected final String TEXT_259 = " submenuActions = ";
	protected final String TEXT_260 = "(";
	protected final String TEXT_261 = ")";
	protected final String TEXT_262 = "createSubmenuActions.get(text);" + NL + "\t\t\t\t\tif (submenuActions == null)"
	...
	protected final String TEXT_263 = "());" + NL + "\t\t\t\t\t}" + NL
			...
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */"
			+ NL + "\tprotected void populateManager(";
	protected final String TEXT_264 = " manager, ";
	protected final String TEXT_265 = " submenuActions, String contributionID)" + NL + "\t{" + NL
			+ "\t\tif (submenuActions != null)" + NL + "\t\t{";
	protected final String TEXT_266 = NL + "\t\t\tfor (";
	protected final String TEXT_267 = " entry : submenuActions.entrySet())" + NL + "\t\t\t{";
	protected final String TEXT_268 = NL + "\t\t\tfor (";
	protected final String TEXT_269 = " entries = submenuActions.entrySet().iterator(); entries.hasNext();)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\t";
	protected final String TEXT_270 = " entry = (";
	protected final String TEXT_271 = ")entries.next();";
	protected final String TEXT_272 = NL + "\t\t\t\t";
	protected final String TEXT_273 = " submenuManager = new ";
	protected final String TEXT_274 = "(";
	protected final String TEXT_275 = "(String)";
	protected final String TEXT_276 = "entry.getKey());" + NL + "\t\t\t\tif (contributionID != null)" + NL + "\t\t\t\t{"
			+ NL + "\t\t\t\t\tmanager.insertBefore(contributionID, submenuManager);" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\telse" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tmanager.add(submenuManager);" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\tpopulateManager(submenuManager, ";
	protected final String TEXT_277 = "(";
	protected final String TEXT_278 = ")";
	protected final String TEXT_279 = "entry.getValue(), null);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + ""
			+ NL + "\t/**" + NL
	...
	protected final String TEXT_280 = " manager, ";
	protected final String TEXT_281 = " submenuActions)" + NL + "\t{" + NL + "\t\tif (submenuActions != null)" + NL
			+ "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_282 = "[] items = manager.getItems();" + NL
			+ "\t\t\tfor (int i = 0; i < items.length; i++)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
	protected final String TEXT_283 = " contributionItem = items[i];" + NL + "\t\t\t\tif (contributionItem instanceof ";
	protected final String TEXT_284 = ")" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
	protected final String TEXT_285 = " submenuManager = (";
	protected final String TEXT_286 = ")contributionItem;" + NL
			+ "\t\t\t\t\tif (submenuActions.containsKey(submenuManager.getMenuText()))" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tdepopulateManager(submenuManager, ";
	protected final String TEXT_287 = "(";
	protected final String TEXT_288 = ")";
	protected final String TEXT_289 = "submenuActions.get(contributionItem));" + NL
			+ "\t\t\t\t\t\tmanager.remove(contributionItem);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
			+ NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_290 = NL + "\t/**" + NL + "\t * This populates the pop-up menu before it appears." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_291 = NL + "\t@Override";
	protected final String TEXT_292 = NL + "\tpublic void menuAboutToShow(";
	protected final String TEXT_293 = " menuManager)" + NL + "\t{" + NL + "\t\tsuper.menuAboutToShow(menuManager);";
	protected final String TEXT_294 = NL + "\t\t";
	protected final String TEXT_295 = " submenuManager = null;" + NL + "" + NL + "\t\tsubmenuManager = new ";
	protected final String TEXT_296 = "(";
	protected final String TEXT_297 = ".INSTANCE.getString(\"_UI_CreateChild_menu_item\"));";
	protected final String TEXT_298 = NL + "\t\tpopulateManager(submenuManager, createChildSubmenuActions, null);";
	protected final String TEXT_299 = NL + "\t\tpopulateManager(submenuManager, createChildActions, null);" + NL
			+ "\t\tmenuManager.insertBefore(\"edit\", submenuManager);";
	protected final String TEXT_300 = NL + NL + "\t\tsubmenuManager = new ";
	protected final String TEXT_301 = "(";
	protected final String TEXT_302 = ".INSTANCE.getString(\"_UI_CreateSibling_menu_item\"));";
	protected final String TEXT_303 = NL + "\t\tpopulateManager(submenuManager, createSiblingSubmenuActions, null);";
	protected final String TEXT_304 = NL + "\t\tpopulateManager(submenuManager, createSiblingActions, null);" + NL
			+ "\t\tmenuManager.insertBefore(\"edit\", submenuManager);";
	protected final String TEXT_305 = NL + NL + "\t\t";
	protected final String TEXT_306 = " extensionMenuManager = new ";
	protected final String TEXT_307 = "(";
	protected final String TEXT_308 = "._UI_Model_Extensions);" + NL
	...
	protected final String TEXT_309 = "\t\t" + NL + "\t\tmenuManager.insertAfter(\"additions\", new Separator());";
	protected final String TEXT_310 = "    ";
	protected final String TEXT_311 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * This inserts global actions before the \"additions-end\" separator." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_312 = NL + "\t@Override";
	protected final String TEXT_313 = NL + "\tprotected void addGlobalActions(";
	protected final String TEXT_314 = " menuManager)" + NL + "\t{" + NL
			+ "\t\tmenuManager.insertAfter(\"additions-end\", new ";
	protected final String TEXT_315 = "(\"ui-actions\"));";
	protected final String TEXT_316 = NL + "\t\tmenuManager.insertAfter(\"ui-actions\", showPropertiesViewAction);";
	protected final String TEXT_317 = NL + "\t\tmenuManager.insertBefore(\"additions-end\", schemeLoadResourceAction);";
	protected final String TEXT_318 = NL + "\t\tmenuManager.insertAfter(\"ui-actions\", refreshViewerAction);";
	protected final String TEXT_319 = NL + NL + "\t\tsuper.addGlobalActions(menuManager);" + NL + "\t}" + NL + "" + NL
	...
	protected final String TEXT_321 = NL + "\tprotected boolean removeAllReferencesOnDelete()" + NL + "\t{" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		stringBuffer.append(genModel
				.getImportedName("org.polarsys.kitalpha.resourcereuse.emfscheme.dialog.LoadingResourceReuseDialog"));
		stringBuffer.append(TEXT_15);
		stringBuffer.append(genModel
				.getImportedName("org.polarsys.kitalpha.resourcereuse.emfscheme.utils.context.ModelReuseContext"));
