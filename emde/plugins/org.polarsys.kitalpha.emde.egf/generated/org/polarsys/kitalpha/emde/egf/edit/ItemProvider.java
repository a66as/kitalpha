...
public class ItemProvider extends org.eclipse.egf.emf.pattern.edit.ItemProvider {
	...
	protected final String TEXT_5 = "} object." + NL
			+ " * <!-- begin-user-doc -->";
	protected final String TEXT_6 = NL
			+ " * @superClass ExtensionItemProviderAdapter";
	protected final String TEXT_7 = NL + " * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_21 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_22 = "(AdapterFactory adapterFactory)" + NL
			+ "\t{" + NL + "\t\tsuper(adapterFactory);" + NL + "\t}" + NL;
	...
	protected final String TEXT_25 = NL
			+ "\tpublic void checkChildCreationExtender(Object object) {" + NL
			+ "\t\tsuper.checkChildCreationExtender(object);" + NL
			+ "\t\tif (object instanceof ";
	protected final String TEXT_26 = ") {" + NL + "\t\t\t";
	protected final String TEXT_27 = " eObject = (EObject) object;";
	protected final String TEXT_28 = NL + "\t\t\t// Process ";
	protected final String TEXT_29 = NL + "\t\t\tif (";
	protected final String TEXT_30 = "PropertyDescriptor != null) {" + NL
			+ "\t\t\t\tObject ";
	...
	protected final String TEXT_37 = "Value)) {" + NL
			+ "\t\t\t\t\titemPropertyDescriptors.remove(";
	protected final String TEXT_38 = "PropertyDescriptor);" + NL
			+ "\t\t\t\t} else if (";
	...
	protected final String TEXT_41 = ") != null) {" + NL
			+ "\t\t\t\t\titemPropertyDescriptors.remove(";
	protected final String TEXT_42 = "PropertyDescriptor);\t\t\t\t  \t\t\t\t\t"
			+ NL + "\t\t\t\t} else if (itemPropertyDescriptors.contains(";
	protected final String TEXT_43 = "PropertyDescriptor) == false) {" + NL
			+ "\t\t\t\t\titemPropertyDescriptors.add(";
	protected final String TEXT_44 = "PropertyDescriptor);" + NL + "\t\t\t\t}"
			+ NL + "\t\t\t}";
	...
	protected final String TEXT_49 = " getPropertyDescriptors(Object object)"
			+ NL + "\t{" + NL + "\t\tif (itemPropertyDescriptors == null)" + NL
			+ "\t\t{" + NL + "\t\t\tsuper.getPropertyDescriptors(object);" + NL;
	protected final String TEXT_50 = NL + "\t\t\tadd";
	protected final String TEXT_51 = "PropertyDescriptor(object);";
	protected final String TEXT_52 = NL + "\t\t}";
	protected final String TEXT_53 = NL + "\t\t// begin-extension-code" + NL
			+ "\t\tcheckChildCreationExtender(object);" + NL
			+ "\t\t// end-extension-code";
	protected final String TEXT_54 = NL + "\t\treturn itemPropertyDescriptors;"
			+ NL + "\t}" + NL;
	protected final String TEXT_55 = NL + "\t/**" + NL
			+ "\t * This adds a property descriptor for the ";
	protected final String TEXT_56 = " feature." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected void add";
	...
	protected final String TEXT_63 = " getChildrenFeatures(Object object)" + NL
			+ "\t{" + NL + "\t\tif (childrenFeatures == null)" + NL + "\t\t{"
			+ NL + "\t\t\tsuper.getChildrenFeatures(object);";
	protected final String TEXT_64 = NL + "\t\t\tchildrenFeatures.add(";
	protected final String TEXT_65 = ");";
	protected final String TEXT_66 = NL + "\t\t}" + NL
			+ "\t\treturn childrenFeatures;" + NL + "\t}" + NL;
	...
	protected final String TEXT_70 = " getChildFeature(Object object, Object child)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_83 = NL
			+ "\tprotected boolean shouldComposeCreationImage() " + NL + "\t{"
			+ NL + "\t\treturn true;" + NL + "\t}" + NL;
	protected final String TEXT_84 = NL + "\t/**" + NL
			+ "\t * This returns the label text for the adapted class." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_85 = NL + "\t@Override";
	protected final String TEXT_86 = NL
			+ "\tpublic String getText(Object object)" + NL + "\t{";
	...
	protected final String TEXT_90 = NL
			+ "\tpublic void notifyChanged(Notification notification)" + NL
			+ "\t{" + NL + "\t\tupdateChildren(notification);";
	...
	protected final String TEXT_96 = "(notification, notification.getNotifier(), false, true));"
			+ NL + "\t\t\t\treturn;";
	protected final String TEXT_97 = NL + "\t\t\tcase ";
	protected final String TEXT_98 = ":";
	protected final String TEXT_99 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_100 = "(notification, notification.getNotifier(), true, false));"
			+ NL + "\t\t\t\treturn;";
	protected final String TEXT_101 = NL + "\t\t\tcase ";
	protected final String TEXT_102 = ":";
	protected final String TEXT_103 = NL + "\t\t\t\tfireNotifyChanged(new ";
	protected final String TEXT_104 = "(notification, notification.getNotifier(), true, true));"
			+ NL + "\t\t\t\treturn;";
	protected final String TEXT_105 = NL + "\t\t}";
	protected final String TEXT_106 = NL
			+ "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
	protected final String TEXT_107 = NL
			+ "\t/**"
			+ NL
			+ "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children"
			+ NL + "\t * that can be created under this object." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_110 = " newChildDescriptors, Object object)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_119 = " selection)" + NL + "\t{" + NL
			+ "\t\tObject childFeature = feature;" + NL
			+ "\t\tObject childObject = child;" + NL;
	protected final String TEXT_120 = NL + "\t\tif (childFeature instanceof ";
	protected final String TEXT_121 = " && ";
	protected final String TEXT_122 = ".isFeatureMap((EStructuralFeature)childFeature))"
			+ NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_123 = ".Entry entry = (FeatureMap.Entry)childObject;"
			+ NL
			+ "\t\t\tchildFeature = entry.getEStructuralFeature();"
			+ NL
			+ "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
	protected final String TEXT_124 = NL + "\t\tboolean qualify =";
	protected final String TEXT_125 = NL + "\t\t\tchildFeature == ";
	protected final String TEXT_126 = NL + NL + "\t\tif (qualify)" + NL
			+ "\t\t{" + NL + "\t\t\treturn getString" + NL
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		if ((genPackage.isExtensibleProviderFactory() || genPackage
		...
		if ((genPackage.isExtensibleProviderFactory() || genPackage
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.polarsys.kitalpha.emde.extension.edit.ExtensionItemProviderAdapter"));
		} else {
			stringBuffer.append(TEXT_9);
			stringBuffer
					.append(genClass.getProviderBaseClassName() != null ? genClass
							.getProviderBaseClassName()
							: genModel
									.getImportedName("org.eclipse.emf.edit.provider.ItemProviderAdapter"));
		}
		stringBuffer.append(TEXT_10);
		for (Iterator<String> i = genPackage.getProviderSupportedTypes()
				.iterator(); i.hasNext();) {
		...
		if (ExtensionHelper.hasExtensibleProviderFactory(genModel)
			...
			for (GenFeature genFeature : genClass.getPropertyFeatures()) {
				if (genFeature.getEcoreFeature() instanceof EReference
					...
					stringBuffer
							.append(genModel
									.getImportedName("org.eclipse.emf.edit.provider.IItemPropertyDescriptor"));
		...
		if (hasNonManyEReferences) {
			...
			for (GenFeature genFeature : genClass.getPropertyFeatures()) {
				if (genFeature.getEcoreFeature() instanceof EReference
					...
					stringBuffer
							.append(genModel
									.getImportedName("org.polarsys.kitalpha.emde.extension.ExtensionModelManager"));
		...
		if ((ExtensionHelper.hasExtensibleProviderFactory(genModel) || ExtensionHelper
				.hasChildCreationExtenders(genModel))
				&& genClass.getProviderBaseClassName() != null) {
		...
		if (!genClass.getLabelNotifyFeatures().isEmpty()
			...
			if (!genClass.getLabelNotifyFeatures().isEmpty()) {
				...
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.emf.edit.provider.ViewerNotification"));
		...
		if (genModel.isCreationCommands()) {
			...
			for (GenClass.ChildCreationData childCreationData : genClass
				...
				if (createFeature.isFeatureMapType()) {
					if (delegatedFeature.isReferenceType()) {
						...
						stringBuffer.append(TEXT_111);
						{
							...
							callParameters.put("delegatedFeature",
									delegatedFeature);
							callParameters.put("createClassifier",
									createClassifier);
							callParameters.put("childCreationData",
									childCreationData);
							callParameters.put("genClass", genClass);
							callParameters.put("genPackage", genPackage);
							callParameters.put("genModel", genModel);
						...
						stringBuffer.append(TEXT_112);
						{
							...
							final Map<String, Object> callParameters = new HashMap<String, Object>();
							callParameters
									.put("createDataType", createDataType);
							callParameters.put("createFeature", createFeature);
							callParameters.put("delegatedFeature",
									delegatedFeature);
							callParameters.put("createClassifier",
					...
					stringBuffer.append(TEXT_113);
					{
						...
						callParameters.put("createFeature", createFeature);
						callParameters
								.put("delegatedFeature", delegatedFeature);
						callParameters
								.put("createClassifier", createClassifier);
						callParameters.put("childCreationData",
								childCreationData);
						callParameters.put("genClass", genClass);
						callParameters.put("genPackage", genPackage);
			...
			if (!genClass.getSharedClassCreateChildFeatures().isEmpty()) {
				...
				stringBuffer.append(genModel.getImportedName(genModel
						.useGenerics() ? "java.util.Collection<?>"
						: "java.util.Collection"));
				...
				if (genClass.hasFeatureMapCreateChildFeatures()) {
					...
					stringBuffer
							.append(genModel
									.getImportedName("org.eclipse.emf.ecore.util.FeatureMapUtil"));
				...
				for (Iterator<GenFeature> i = genClass
						.getSharedClassCreateChildFeatures().iterator(); i
						.hasNext();) {
					GenFeature createFeature = i.next();
					stringBuffer.append(TEXT_125);
					stringBuffer.append(createFeature
							.getQualifiedFeatureAccessor());
		...
		if (genClass.getProviderExtendsGenClass() == null
				...
				&& (!genPackage.isExtensibleProviderFactory() || genClass
						.getProviderExtendsGenClass().getGenPackage()
						.isExtensibleProviderFactory() != genPackage
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.common.util.ResourceLocator"));
			stringBuffer.append(TEXT_131);
			if (genPackage.isExtensibleProviderFactory()) {
				stringBuffer.append(TEXT_132);
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.emf.edit.provider.IChildCreationExtender"));
				stringBuffer.append(TEXT_133);
			} else {
				stringBuffer.append(TEXT_134);
				stringBuffer
						.append(genPackage.getImportedEditPluginClassName());
