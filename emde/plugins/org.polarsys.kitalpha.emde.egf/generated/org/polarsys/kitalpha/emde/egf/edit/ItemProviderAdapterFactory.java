...
public class ItemProviderAdapterFactory extends
		org.eclipse.egf.emf.pattern.edit.ItemProviderAdapterFactory {
	protected static String nl;

	public static synchronized ItemProviderAdapterFactory create(
	...
	protected final String TEXT_17 = NL + "\t/**" + NL
			+ "\t * This helps manage the child creation extenders." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	...
	protected final String TEXT_24 = "();" + NL + "" + NL + "\t/**" + NL
			+ "\t * This constructs an instance." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	...
	protected final String TEXT_31 = " = null;" + NL + "" + NL + "\t/**" + NL
			+ "\t * This determines the delegate factory for the package." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	...
	protected final String TEXT_35 = " rootAdapterFactory = getRootAdapterFactory();"
			+ NL
			+ "\t\t\tif (rootAdapterFactory instanceof ComposedAdapterFactory)"
			+ NL + "\t\t\t{" + NL + "\t\t\t\t";
	protected final String TEXT_36 = " delegateAdapterFactory ="
			+ NL
			+ "\t\t\t\t\t((ComposedAdapterFactory)rootAdapterFactory).getFactoryForType(";
	protected final String TEXT_37 = ".getPackage());" + NL
			+ "\t\t\t\tif (delegateAdapterFactory instanceof ";
	...
	protected final String TEXT_43 = "} instances." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	protected final String TEXT_44 = " ";
	protected final String TEXT_45 = "ItemProvider;" + NL + "" + NL + "\t/**"
			+ NL + "\t * This creates an adapter for a {@link ";
	protected final String TEXT_46 = "}." + NL + "\t * <!-- begin-user-doc -->"
	...
	protected final String TEXT_50 = "ItemProvider == null)" + NL + "\t\t{"
			+ NL + "\t\t\t";
	protected final String TEXT_51 = "ItemProvider = new ";
	protected final String TEXT_52 = "(this);" + NL + "\t\t}" + NL + "" + NL
			+ "\t\treturn ";
	...
	protected final String TEXT_62 = NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic Adapter create";
	protected final String TEXT_63 = "Adapter()" + NL + "\t{" + NL
			+ "\t\treturn" + NL + "\t\t\tget";
	protected final String TEXT_64 = "() == null ?" + NL + "\t\t\t\tnull :"
			+ NL + "\t\t\t\tget";
	...
	protected final String TEXT_67 = NL
			...
			+ NL + "\t{" + NL
			+ "\t\tthis.parentAdapterFactory = parentAdapterFactory;" + NL
			+ "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_71 = NL
			+ "\tpublic Adapter adapt(Notifier notifier, Object type)" + NL
			+ "\t{" + NL + "\t\treturn super.adapt(notifier, this);" + NL
			+ "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_73 = NL
			+ "\tpublic Object adapt(Object object, Object type)" + NL + "\t{"
			+ NL + "\t\tif (isFactoryForType(type))" + NL + "\t\t{" + NL
			+ "\t\t\tObject adapter = super.adapt(object, type);" + NL
	...
	protected final String TEXT_85 = NL
			...
			+ NL + "\t{" + NL + "\t\tsuper.associate(adapter, target);" + NL
			+ "\t\tif (adapter != null)" + NL + "\t\t{" + NL
			+ "\t\t\tdisposable.add(adapter);" + NL + "\t\t}" + NL + "\t}" + NL;
	protected final String TEXT_86 = NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_87 = " getChildCreationExtenders()"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_89 = " editingDomain)"
			+ NL
			+ "\t{"
			+ NL
	...
	protected final String TEXT_91 = NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tpublic void fireNotifyChanged(Notification notification)" + NL
			+ "\t{" + NL
			+ "\t\tchangeNotifier.fireNotifyChanged(notification);" + NL + ""
			+ NL + "\t\tif (parentAdapterFactory != null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_98 = NL + "\t/**" + NL
			+ "\t * A child creation extender for the {@link ";
	protected final String TEXT_99 = "}." + NL + "\t * <!-- begin-user-doc -->"
			+ NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_102 = NL + "\t\t{" + NL + "\t\t\t/**" + NL
			+ "\t\t\t * The child descriptors being populated." + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */" + NL + "\t\t\tprotected ";
	protected final String TEXT_103 = " newChildDescriptors;" + NL + "" + NL
			+ "\t\t\t/**" + NL
			+ "\t\t\t * The domain in which to create the children." + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */" + NL + "\t\t\tprotected ";
	...
	protected final String TEXT_112 = " object)" + NL + "\t\t\t{" + NL
			+ "\t\t\t\t// begin-extension-code" + NL + "\t\t\t\tif (";
	...
	protected final String TEXT_116 = NL + "\t\t\t\t\treturn null;\t\t\t\t"
	...
	protected final String TEXT_122 = NL + "\t\t\t\treturn null;" + NL
			+ "\t\t\t}" + NL + " ";
	protected final String TEXT_123 = NL + "\t\t\t/**" + NL
			+ "\t\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated"
			+ NL + "\t\t\t */" + NL + "\t\t\tprotected ";
	protected final String TEXT_124 = " createChildParameter(Object feature, Object child)"
			+ NL + "\t\t\t{" + NL + "\t\t\t\treturn new ";
	protected final String TEXT_125 = "(null, feature, child);" + NL
			+ "\t\t\t}" + NL + "" + NL + "\t\t}" + NL + "" + NL + "\t\t/**"
			+ NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL
			+ "\t\t */" + NL + "\t\tpublic ";
	...
	protected final String TEXT_129 = "();" + NL
			+ "\t\t   new CreationSwitch(result, editingDomain).doSwitch((";
	protected final String TEXT_130 = ")object);" + NL
	...
	protected final String TEXT_131 = " getResourceLocator()" + NL + "\t\t{"
			+ NL + "\t\t\treturn ";
	protected final String TEXT_132 = ".INSTANCE;" + NL + "\t\t}" + NL + "\t}"
			+ NL;
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		String _ArrayList = genModel
				.getImportedName(useGenerics ? "java.util.ArrayList<java.lang.Object>"
						: "java.util.ArrayList");
		String _Collection = genModel
				.getImportedName(useGenerics ? "java.util.Collection<java.lang.Object>"
						: "java.util.Collection");
		genModel.markImportLocation(stringBuffer);
		stringBuffer.append(TEXT_4);
		stringBuffer
				.append(genPackage.getItemProviderAdapterFactoryClassName());
		...
		if (genPackage.isDisposableProviderFactory()) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.edit.provider.IDisposable"));
		}
		...
		if (genPackage.isDisposableProviderFactory()
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.edit.provider.Disposable"));
		...
		if (genPackage.isExtensibleProviderFactory()) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.polarsys.kitalpha.emde.extension.edit.ChildCreationExtenderManager"));
		...
		for (GenPackage genDelegate : genPackage.getAdapterDelegatePackages()) {
			...
			stringBuffer.append(genDelegate
					.getImportedAdapterFactoryClassName());
			stringBuffer.append(TEXT_30);
			stringBuffer.append(genPackage
					.getUncapAdapterFactoryDelegateName(genDelegate));
			stringBuffer.append(TEXT_31);
			stringBuffer.append(genDelegate
					.getImportedAdapterFactoryClassName());
			stringBuffer.append(TEXT_32);
			stringBuffer.append(genPackage
					.getAdapterFactoryDelegateName(genDelegate));
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.common.notify.AdapterFactory"));
		...
		for (GenClass genClass : genPackage.getGenClasses()) {
			if (!genClass.isAbstract()
					&& genClass.getProvider() != GenProviderKind.NONE_LITERAL) {
		...
		if (genModel.getRuntimePlatform() == GenRuntimePlatform.GWT) {
			stringBuffer.append(genModel
					.getImportedName("org.eclipse.emf.common.util.Reflect"));
		...
		if (genPackage.isExtensibleProviderFactory()) {
			...
			stringBuffer.append(genModel
					.getImportedName(useGenerics ? "java.util.Collection<?>"
							: "java.util.Collection"));
			stringBuffer.append(TEXT_88);
			stringBuffer
					.append(genModel
							.getImportedName("org.eclipse.emf.edit.domain.EditingDomain"));
		...
		if (genPackage.isChildCreationExtenders()) {
			for (Map.Entry<GenPackage, Map<GenClass, List<GenClass.ChildCreationData>>> packageEntry : ExtensionHelper
				...
				stringBuffer.append(packageEntry.getKey()
						.getImportedPackageInterfaceName());
				stringBuffer.append(TEXT_99);
				stringBuffer.append(genPackage
						.getChildCreationExtenderName(packageEntry.getKey()));
				stringBuffer.append(TEXT_100);
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.emf.edit.provider.IChildCreationExtender"));
				stringBuffer.append(TEXT_101);
				stringBuffer.append(genModel.getImportedName(packageEntry
						.getKey().getQualifiedSwitchClassName()));
				stringBuffer.append(useGenerics ? "<Object>" : "");
				stringBuffer.append(TEXT_102);
				stringBuffer.append(genModel
						.getImportedName(useGenerics ? "java.util.List<Object>"
								: "java.util.List"));
				...
				for (Map.Entry<GenClass, List<GenClass.ChildCreationData>> classEntry : packageEntry
					...
					stringBuffer
							.append(genPackage.getClassUniqueName(genClass));
						...
						if (createFeature.isFeatureMapType()) {
							if (delegatedFeature.isReferenceType()) {
								...
								stringBuffer.append(TEXT_117);
								{
									...
									InternalPatternContext ictx = (InternalPatternContext) ctx;
									new Node.DataLeaf(ictx.getNode(),
											getClass(), null,
											stringBuffer.toString());
									stringBuffer.setLength(0);

									final Map<String, Object> callParameters = new HashMap<String, Object>();
									callParameters.put("createClass",
											createClass);
									callParameters.put("createFeature",
											createFeature);
								...
								stringBuffer.append(TEXT_118);
								{
									...
									final Map<String, Object> callParameters = new HashMap<String, Object>();
									callParameters.put("createDataType",
											createDataType);
									callParameters.put("createFeature",
											createFeature);
									callParameters.put("delegatedFeature",
				...
				stringBuffer
						.append(genModel
								.getImportedName("org.eclipse.emf.edit.command.CommandParameter"));
