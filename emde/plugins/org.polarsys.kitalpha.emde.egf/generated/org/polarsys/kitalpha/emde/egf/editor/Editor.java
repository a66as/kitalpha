...
public class Editor extends org.eclipse.egf.emf.pattern.editor.Editor {
	...
	protected final String TEXT_3 = ";" + NL + "" + NL + "" + NL
			...
			+ "import java.io.InputStream;" + NL + "" + NL
			+ "import java.util.ArrayList;" + NL
			+ "import java.util.Collection;" + NL
			+ "import java.util.Collections;" + NL
			+ "import java.util.EventObject;" + NL
			+ "import java.util.HashMap;" + NL + "import java.util.Iterator;"
			+ NL + "import java.util.LinkedHashMap;" + NL
			+ "import java.util.List;" + NL + "import java.util.Map;";
	protected final String TEXT_4 = NL + NL
			+ "import org.eclipse.core.resources.IFile;" + NL
			+ "import org.eclipse.core.resources.IMarker;" + NL
			+ "import org.eclipse.core.resources.IResource;" + NL
	...
	protected final String TEXT_6 = NL
			+ "import org.eclipse.core.runtime.CoreException;" + NL
			+ "import org.eclipse.core.runtime.IPath;";
	protected final String TEXT_7 = NL
			+ "import org.eclipse.core.runtime.IProgressMonitor;" + NL
			+ "import org.eclipse.core.runtime.NullProgressMonitor;" + NL + ""
			+ NL + "import org.eclipse.jface.action.IMenuListener;" + NL
			+ "import org.eclipse.jface.action.IMenuManager;" + NL
			+ "import org.eclipse.jface.action.IStatusLineManager;" + NL
			+ "import org.eclipse.jface.action.IToolBarManager;" + NL
			+ "import org.eclipse.jface.action.MenuManager;" + NL
			+ "import org.eclipse.jface.action.Separator;" + NL + "" + NL
	...
	protected final String TEXT_9 = NL
			+ "import org.eclipse.jface.viewers.ISelection;" + NL
			+ "import org.eclipse.jface.viewers.ISelectionChangedListener;"
			+ NL + "import org.eclipse.jface.viewers.ISelectionProvider;" + NL
			+ "import org.eclipse.jface.viewers.IStructuredSelection;";
	protected final String TEXT_10 = NL
			+ "import org.eclipse.jface.viewers.ListViewer;";
	protected final String TEXT_11 = NL
			+ "import org.eclipse.jface.viewers.SelectionChangedEvent;" + NL
			+ "import org.eclipse.jface.viewers.StructuredSelection;" + NL
			+ "import org.eclipse.jface.viewers.StructuredViewer;";
	protected final String TEXT_12 = NL
			+ "import org.eclipse.jface.viewers.TableLayout;" + NL
			+ "import org.eclipse.jface.viewers.TableViewer;";
	protected final String TEXT_13 = NL
			+ "import org.eclipse.jface.viewers.TreeViewer;" + NL
			+ "import org.eclipse.jface.viewers.Viewer;" + NL + "" + NL
			+ "import org.eclipse.swt.SWT;" + NL + "" + NL
			+ "import org.eclipse.swt.custom.CTabFolder;" + NL + "" + NL
			+ "import org.eclipse.swt.dnd.DND;" + NL
			+ "import org.eclipse.swt.dnd.Transfer;" + NL + "" + NL
			+ "import org.eclipse.swt.events.ControlAdapter;" + NL
			+ "import org.eclipse.swt.events.ControlEvent;" + NL + "" + NL
			+ "import org.eclipse.swt.graphics.Point;";
	protected final String TEXT_14 = NL + NL
			+ "import org.eclipse.swt.layout.FillLayout;";
	protected final String TEXT_15 = NL + NL
			+ "import org.eclipse.swt.widgets.Composite;" + NL
			+ "import org.eclipse.swt.widgets.Menu;";
	protected final String TEXT_16 = NL
			+ "import org.eclipse.swt.widgets.Table;" + NL
	...
	protected final String TEXT_19 = NL + NL
			+ "import org.eclipse.ui.IActionBars;" + NL
			+ "import org.eclipse.ui.IEditorInput;" + NL
			+ "import org.eclipse.ui.IEditorPart;" + NL
			+ "import org.eclipse.ui.IEditorSite;";
	protected final String TEXT_20 = NL
			+ "import org.eclipse.ui.IFileEditorInput;";
	protected final String TEXT_21 = NL
			+ "import org.eclipse.ui.IPartListener;" + NL
			+ "import org.eclipse.ui.IWorkbenchPart;" + NL
			+ "import org.eclipse.ui.PartInitException;";
	protected final String TEXT_22 = NL + NL
			+ "import org.eclipse.ui.dialogs.SaveAsDialog;" + NL + "" + NL
			+ "import org.eclipse.ui.ide.IGotoMarker;";
	protected final String TEXT_23 = NL;
	protected final String TEXT_24 = NL
			+ "import org.eclipse.ui.part.FileEditorInput;";
	protected final String TEXT_25 = NL
			+ "import org.eclipse.ui.part.MultiPageEditorPart;" + NL + "" + NL
	...
	protected final String TEXT_28 = NL + NL
			+ "import org.eclipse.emf.common.ui.editor.ProblemEditorPart;" + NL
			+ "" + NL
			+ "import org.eclipse.emf.common.ui.viewer.IViewerProvider;" + NL
			+ "" + NL + "import org.eclipse.emf.common.util.BasicDiagnostic;"
			+ NL + "import org.eclipse.emf.common.util.Diagnostic;" + NL
			+ "import org.eclipse.emf.common.util.URI;" + NL;
	...
	protected final String TEXT_39 = " model editor." + NL
			+ " * <!-- begin-user-doc -->";
	protected final String TEXT_40 = NL
			+ " * @implements ModelExtensionListener";
	protected final String TEXT_41 = " " + NL + " * <!-- end-user-doc -->" + NL
	...
	protected final String TEXT_63 = " extensions, String prefix)" + NL + "\t{"
			+ NL + "\t\t";
	protected final String TEXT_64 = " result = new ";
	protected final String TEXT_65 = "();";
	protected final String TEXT_66 = NL
			+ "\t\tfor (String extension : extensions)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_68 = NL + "\t\t}" + NL
			+ "\t\treturn Collections.unmodifiableList(result);" + NL + "\t}"
			+ NL;
	...
	protected final String TEXT_70 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected TreeViewer parentViewer;" + NL + ""
			+ NL + "\t/**" + NL + "\t * This shows how a tree view works." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected TreeViewer treeViewer;" + NL + ""
			+ NL + "\t/**" + NL + "\t * This shows how a list view works." + NL
			+ "\t * A list viewer doesn't support icons." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ListViewer listViewer;" + NL + ""
			+ NL + "\t/**" + NL + "\t * This shows how a table view works."
			+ NL + "\t * A table can be used as a list with icons." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected TableViewer tableViewer;" + NL + ""
			+ NL + "\t/**" + NL
			+ "\t * This shows how a tree view with columns works." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected TreeViewer treeViewerWithColumns;"
			+ NL + "" + NL + "\t/**" + NL
			+ "\t * This keeps track of the active viewer pane, in the book."
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ViewerPane currentViewerPane;";
	...
	protected final String TEXT_84 = ".this);" + NL
			+ "\t\t\t\t\t\thandleActivate();" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t\telse if (p == ";
	protected final String TEXT_85 = ".this)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\thandleActivate();" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
			+ NL + "\t\t\tpublic void partBroughtToTop(IWorkbenchPart p)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\t// Ignore." + NL + "\t\t\t}" + NL
			+ "\t\t\tpublic void partClosed(IWorkbenchPart p)" + NL + "\t\t\t{"
			+ NL + "\t\t\t\t// Ignore." + NL + "\t\t\t}" + NL
			+ "\t\t\tpublic void partDeactivated(IWorkbenchPart p)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\t// Ignore." + NL + "\t\t\t}" + NL
			+ "\t\t\tpublic void partOpened(IWorkbenchPart p)" + NL + "\t\t\t{"
			+ NL + "\t\t\t\t// Ignore." + NL + "\t\t\t}" + NL + "\t\t};" + NL
			+ "" + NL + "\t/**" + NL
	...
	protected final String TEXT_89 = "();" + NL + "" + NL + "\t/**" + NL
			+ "\t * Resources that have been saved." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected ";
	...
	protected final String TEXT_93 = "();"
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tprotected EContentAdapter problemIndicationAdapter = " + NL
	...
	protected final String TEXT_97 = "\t\t\t\t\t\t\t\t\t\t\t\t\t\t"
			...
			+ NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\telse" + NL
			+ "\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\tresourceToDiagnosticMap.remove(resource);" + NL
			+ "\t\t\t\t\t\t\t}" + NL + "" + NL
			+ "\t\t\t\t\t\t\tif (updateProblemIndication)" + NL
			+ "\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\tgetSite().getShell().getDisplay().asyncExec"
			+ NL + "\t\t\t\t\t\t\t\t\t(new Runnable()" + NL
			+ "\t\t\t\t\t\t\t\t\t {" + NL
			+ "\t\t\t\t\t\t\t\t\t\t public void run()" + NL
			+ "\t\t\t\t\t\t\t\t\t\t {" + NL
			+ "\t\t\t\t\t\t\t\t\t\t\t updateProblemIndication();" + NL
			+ "\t\t\t\t\t\t\t\t\t\t }" + NL + "\t\t\t\t\t\t\t\t\t });" + NL
			+ "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tbreak;" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\telse" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tsuper.notifyChanged(notification);" + NL + "\t\t\t\t}"
			+ NL + "\t\t\t}" + NL;
	protected final String TEXT_98 = NL + "\t\t\t@Override";
	protected final String TEXT_99 = NL
			+ "\t\t\tprotected void setTarget(Resource target)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\tbasicSetTarget(target);" + NL
			+ "\t\t\t}" + NL;
	protected final String TEXT_100 = NL + "\t\t\t@Override";
	protected final String TEXT_101 = NL
			+ "\t\t\tprotected void unsetTarget(Resource target)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\tbasicUnsetTarget(target);" + NL
			+ "\t\t\t}" + NL + "\t\t};";
	...
	protected final String TEXT_106 = "();"
			...
			+ NL + "\t\t\t\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\t\t\t\tchangedResources.add(resource);" + NL
			+ "\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t}" + NL
			+ "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "" + NL
			+ "\t\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t\t}" + NL + ""
			+ NL + "\t\t\t\t\t\tpublic ";
	protected final String TEXT_107 = " getChangedResources()" + NL
			+ "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\treturn changedResources;"
			+ NL + "\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\tpublic ";
	protected final String TEXT_108 = " getRemovedResources()"
			+ NL
			+ "\t\t\t\t\t\t{"
			+ NL
	...
	protected final String TEXT_109 = ".this, false);"
			+ NL
			+ "\t\t\t\t\t\t\t\t\t }"
			+ NL
			+ "\t\t\t\t\t\t\t\t }"
	...
	protected final String TEXT_110 = ".this)" + NL + "\t\t\t\t\t\t\t\t\t {"
			+ NL + "\t\t\t\t\t\t\t\t\t\t handleActivate();" + NL
			+ "\t\t\t\t\t\t\t\t\t }" + NL + "\t\t\t\t\t\t\t\t }" + NL
			+ "\t\t\t\t\t\t\t });" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\tcatch (CoreException exception)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\t";
	protected final String TEXT_111 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t};";
	protected final String TEXT_112 = NL
			...
			+ NL + "\t\t  //" + NL + "\t\t  setSelection(getSelection());" + NL
			+ "\t\t}" + NL + "" + NL + "\t\tif (!removedResources.isEmpty())"
			+ NL + "\t\t{" + NL + "\t\t\tif (handleDirtyConflict())" + NL
			+ "\t\t\t{" + NL + "\t\t\t\tgetSite().getPage().closeEditor(";
	protected final String TEXT_113 = ".this, false);"
			+ NL
			+ "\t\t\t}"
			+ NL
			+ "\t\t\telse"
	...
	protected final String TEXT_119 = NL
			...
			+ NL + "\t\t\t{" + NL
			+ "\t\t\t\tsetSelection(StructuredSelection.EMPTY);" + NL
			+ "\t\t\t}";
	protected final String TEXT_120 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected void updateProblemIndication()" + NL
			+ "\t{" + NL + "\t\tif (updateProblemIndication)" + NL + "\t\t{"
			+ NL + "\t\t\tBasicDiagnostic diagnostic =" + NL
			+ "\t\t\t\tnew BasicDiagnostic" + NL + "\t\t\t\t\t(Diagnostic.OK,"
			+ NL + "\t\t\t\t\t \"";
	protected final String TEXT_121 = "\",";
	protected final String TEXT_122 = NL + "\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t null," + NL
	...
	protected final String TEXT_127 = NL
			...
			+ NL + "\t\t\t\tproblemEditorPart.setDiagnostic(diagnostic);";
	...
	protected final String TEXT_129 = NL
			...
			+ NL + "\t\t\t\t\tsetActivePage(lastEditorPage);" + NL
			+ "\t\t\t\t\tshowTabs();" + NL + "\t\t\t\t}" + NL
			+ "\t\t\t\tcatch (PartInitException exception)" + NL + "\t\t\t\t{"
			+ NL + "\t\t\t\t\t";
	protected final String TEXT_130 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}";
	protected final String TEXT_131 = NL
			...
			+ NL + "\t\t\t\tif (diagnostic.getSeverity() != Diagnostic.OK)"
			+ NL + "\t\t\t\t{" + NL + "\t\t\t\t\ttry" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tmarkerHelper.createMarkers(diagnostic);" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t\tcatch (CoreException exception)"
			+ NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
	protected final String TEXT_132 = ".INSTANCE.log(exception);" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
	protected final String TEXT_133 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tprotected boolean handleDirtyConflict()" + NL
			+ "\t{" + NL + "\t\treturn" + NL
			+ "\t\t\tMessageDialog.openQuestion" + NL
			+ "\t\t\t\t(getSite().getShell()," + NL
			+ "\t\t\t\t getString(\"_UI_FileConflict_label\"),";
	protected final String TEXT_134 = NL
			+ "\t\t\t\t getString(\"_WARN_FileConflict\"));";
	protected final String TEXT_135 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * This creates a model editor." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	...
	protected final String TEXT_152 = NL + NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tpublic void setCurrentViewerPane(ViewerPane viewerPane)" + NL
			+ "\t{" + NL + "\t\tif (currentViewerPane != viewerPane)" + NL
			+ "\t\t{" + NL + "\t\t\tif (currentViewerPane != null)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\tcurrentViewerPane.showFocus(false);"
			+ NL + "\t\t\t}" + NL + "\t\t\tcurrentViewerPane = viewerPane;"
			+ NL + "\t\t}" + NL
	...
	protected final String TEXT_153 = NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic Viewer getViewer()" + NL + "\t{" + NL
			+ "\t\treturn currentViewer;" + NL + "\t}" + NL + "\t" + NL
			+ "\t/**" + NL
			+ "\t * This returns viewers supported in this editor" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_154 = NL
			...
			+ NL
			+ "\t\tfor (Collection<EmdeViewerFilterAction> actionList : viewerFilterActions.values()) {"
			+ NL + "\t\t\tfor (EmdeViewerFilterAction action : actionList) {"
			+ NL
			+ "\t\t\t\tif (action.getExtendedModel().getName().equals(nsURI))"
			+ NL + "\t\t\t\t\taction.setChecked(false);" + NL + "\t\t\t}" + NL
			+ "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_183 = NL
			...
			+ NL + "\t\t\treturn basicDiagnostic;" + NL + "\t\t}" + NL
	...
	protected final String TEXT_200 = "(adapterFactory";
	protected final String TEXT_201 = ", selectionViewer";
	...
	protected final String TEXT_215 = ", parentViewer";
	...
	protected final String TEXT_217 = NL + "\t\t\t}" + NL + "" + NL
			...
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	protected final String TEXT_218 = ".this)" + NL + "\t\t\t\t\t{";
	...
	protected final String TEXT_228 = "(adapterFactory";
	...
	protected final String TEXT_242 = "(adapterFactory";
	protected final String TEXT_243 = ", treeViewer";
	...
	protected final String TEXT_245 = NL + "\t\t\t}" + NL + "" + NL
			...
			+ "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	protected final String TEXT_246 = ".this)" + NL + "\t\t\t\t\t{";
	...
	protected final String TEXT_259 = "(adapterFactory";
	...
	protected final String TEXT_277 = ", treeViewerWithColumns";
	...
	protected final String TEXT_285 = ", selectionViewer";
	...
	protected final String TEXT_287 = NL
			...
			+ NL + "\t\t// area if there are more than one page" + NL
	...
	protected final String TEXT_289 = NL
			...
			+ NL + "\t\t\t\t\t\tguard = false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t });" + NL + "" + NL
			+ "\t\tgetSite().getShell().getDisplay().asyncExec" + NL
			+ "\t\t\t(new Runnable()" + NL + "\t\t\t {" + NL
			+ "\t\t\t\t public void run()" + NL + "\t\t\t\t {" + NL
			+ "\t\t\t\t\t updateProblemIndication();" + NL + "\t\t\t\t }" + NL
			+ "\t\t\t });" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * If there is just one page in the multi-page editor part,"
			+ NL + "\t * this hides the single tab at the bottom." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_290 = NL
			...
			+ NL + "\t * this shows the tabs at the bottom." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_291 = NL
			...
			+ NL + "\t\t\t\tPoint point = getContainer().getSize();" + NL
			+ "\t\t\t\tgetContainer().setSize(point.x, point.y - 6);" + NL
			+ "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**"
			+ NL + "\t * This is used to track the active viewer." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	...
	protected final String TEXT_293 = NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_294 = NL + "\t@SuppressWarnings(\"";
	protected final String TEXT_295 = "rawtypes";
	protected final String TEXT_296 = "unchecked";
	...
	protected final String TEXT_300 = NL
			...
			+ "\t\t\treturn this;" + NL + "\t\t}";
	protected final String TEXT_301 = NL + "\t\telse" + NL + "\t\t{" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tpublic IContentOutlinePage getContentOutlinePage()" + NL
			+ "\t{" + NL + "\t\tif (contentOutlinePage == null)" + NL + "\t\t{"
			+ NL + "\t\t\t// The content outline is just a tree." + NL
			+ "\t\t\t//" + NL
	...
	protected final String TEXT_304 = NL
			...
			+ "\t\t\t\t\tfor (";
	protected final String TEXT_305 = " resource : viewerFilterActions.keySet()) {"
			+ NL + "\t\t\t\t\t\tfor (";
	protected final String TEXT_306 = " filterAction : viewerFilterActions.get(resource)) {"
			+ NL
	...
	protected final String TEXT_308 = "(adapterFactory";
	protected final String TEXT_309 = ", contentOutlineViewer";
	...
	protected final String TEXT_316 = NL + "\t\t\t\tpublic void dispose() {";
	protected final String TEXT_317 = NL
			...
			+ "\t\t\t\t\tfor (";
	protected final String TEXT_318 = " resource : viewerFilterActions.keySet()) {"
			+ NL + "\t\t\t\t\t\tfor (";
	protected final String TEXT_319 = " filterAction : viewerFilterActions.get(resource)) {"
			+ NL
	...
	protected final String TEXT_320 = "\t\t\t\t\t"
			...
			+ NL + "\t\t\t\t\t }" + NL + "\t\t\t\t });" + NL + "\t\t}" + NL
			+ "" + NL + "\t\treturn contentOutlinePage;" + NL + "\t}" + NL + ""
			+ NL + "\t/**" + NL
			+ "\t * This accesses a cached version of the property sheet." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tpublic IPropertySheetPage getPropertySheetPage()" + NL + "\t{"
			+ NL + "\t\tif (propertySheetPage == null)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_323 = " selection)" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t";
	protected final String TEXT_324 = ".this.setSelectionToViewer(selection);"
			+ NL + "\t\t\t\t\t\t";
	protected final String TEXT_325 = ".this.setFocus();" + NL + "\t\t\t\t\t}"
			+ NL;
	...
	protected final String TEXT_330 = NL + "\t\t{" + NL + "\t\t\tIterator";
	protected final String TEXT_331 = "<?>";
	protected final String TEXT_332 = " selectedElements = ((IStructuredSelection)selection).iterator();"
			+ NL
	...
	protected final String TEXT_333 = NL
			...
			+ NL + "\t\t\t\t{" + NL + "\t\t\t\t\t";
	protected final String TEXT_334 = " selectionList = new ";
	...
	protected final String TEXT_337 = " selectionList = new ";
	...
	protected final String TEXT_343 = NL
			...
			+ "\t\t//" + NL + "\t\tfinal ";
	protected final String TEXT_344 = " saveOptions = new ";
	...
	protected final String TEXT_347 = NL
			...
			+ NL + "\t\t//" + NL + "\t\t";
	protected final String TEXT_348 = " operation =" + NL + "\t\t\tnew ";
	...
	protected final String TEXT_351 = NL + "\t\t\t\tpublic void ";
	protected final String TEXT_352 = "(IProgressMonitor monitor)" + NL
			+ "\t\t\t\t{" + NL
	...
	protected final String TEXT_360 = NL
			...
			+ NL + "\t\t\tfirePropertyChange(IEditorPart.PROP_DIRTY);" + NL
			+ "\t\t}" + NL + "\t\tcatch (Exception exception)" + NL + "\t\t{"
			+ NL + "\t\t\t// Something went wrong that shouldn't." + NL
			+ "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_361 = ".INSTANCE.log(exception);"
			+ NL
			+ "\t\t}"
			+ NL
			+ "\t\tupdateProblemIndication = true;"
	...
	protected final String TEXT_363 = NL + "\tpublic boolean isSaveAsAllowed()"
	...
	protected final String TEXT_365 = NL + "\tpublic void doSaveAs()" + NL
			+ "\t{";
	protected final String TEXT_366 = NL + "\t\tnew ";
	protected final String TEXT_367 = "(getSite().getShell(), null, SWT.NONE)"
			+ NL + "\t\t\t{";
	protected final String TEXT_368 = NL + "\t\t\t\t@Override";
	protected final String TEXT_369 = NL + "\t\t\t\tprotected boolean isSave()"
	...
	protected final String TEXT_371 = NL
			...
			+ NL + "\t\t\t\t\t";
	protected final String TEXT_372 = " uris = getURIs();" + NL
			+ "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tURI uri = ";
	protected final String TEXT_373 = "uris.get(0);" + NL
			+ "\t\t\t\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_374 = "(uri));" + NL
			+ "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}.open();";
	protected final String TEXT_375 = NL + "\t\tString[] filters = ";
	protected final String TEXT_376 = "(String[])";
	protected final String TEXT_377 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);"
			+ NL + "\t\tString[] files = ";
	protected final String TEXT_378 = ".openFilePathDialog(getSite().getShell(), ";
	protected final String TEXT_379 = ".SAVE, filters);" + NL
			+ "\t\tif (files.length > 0)" + NL + "\t\t{" + NL
			+ "\t\t\tURI uri = URI.createFileURI(files[0]);" + NL
			+ "\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_380 = "(uri));" + NL + "\t\t}";
	protected final String TEXT_381 = NL
			...
			+ NL + "\t\t\t}" + NL + "\t\t}";
	protected final String TEXT_382 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL
			+ "\tprotected void doSaveAs(URI uri, IEditorInput editorInput)"
			+ NL + "\t{" + NL + "\t\t(";
	protected final String TEXT_383 = "(Resource)";
	protected final String TEXT_384 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);"
			+ NL
	...
	protected final String TEXT_386 = NL
			...
			+ "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_387 = ".INSTANCE.log(exception);" + NL
			+ "\t\t}" + NL + "\t}";
	protected final String TEXT_388 = NL + NL + "\t/**" + NL
	...
	protected final String TEXT_392 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_393 = NL + "\t@Override";
	protected final String TEXT_394 = NL + "\tpublic void setFocus()" + NL
			+ "\t{";
	protected final String TEXT_395 = NL + "\t\tif (currentViewerPane != null)"
	...
	protected final String TEXT_397 = NL
			...
			+ NL + "\t * Calling this result will notify the listeners." + NL
			+ "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
	...
	protected final String TEXT_402 = NL
			...
			+ NL + "" + NL + "\t\tif (statusLineManager != null)" + NL
			+ "\t\t{" + NL
			+ "\t\t\tif (selection instanceof IStructuredSelection)" + NL
			+ "\t\t\t{" + NL + "\t\t\t\t";
	protected final String TEXT_403 = " collection = ((IStructuredSelection)selection).toList();"
			+ NL
	...
	protected final String TEXT_406 = NL + "\t\t\t\t\t\tbreak;" + NL
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL
			+ "\t\t\telse" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_407 = NL
			...
			+ NL + "\t{" + NL + "\t\treturn ";
	protected final String TEXT_408 = ".INSTANCE.getString(key);"
			+ NL
			+ "\t}"
			+ NL
			+ ""
			...
			+ "\t{" + NL + "\t\treturn ";
	protected final String TEXT_409 = ".INSTANCE.getString(key, new Object [] { s1 });"
			+ NL
			+ "\t}"
			+ NL
			+ ""
	...
	protected final String TEXT_411 = NL + "\tpublic void dispose()" + NL
	...
	protected final String TEXT_415 = " resource : viewerFilterActions.keySet()) {"
			+ NL + "\t\t\tfor (";
	protected final String TEXT_416 = " filterAction : viewerFilterActions.get(resource)) {"
			+ NL + "\t\t\t\tfilterAction.removePropertyChangeListener((";
	protected final String TEXT_417 = ") getActionBarContributor());" + NL
			+ "\t\t\t\tfilterAction.dispose();" + NL + "\t\t\t}" + NL + "\t\t}"
			+ NL + "\t\t// Unregister this editor for ExtendedModel state" + NL
			+ "\t\t//" + NL + "\t\t";
	protected final String TEXT_418 = ".getInstance(getEditingDomain().getResourceSet()).removeListener(this);";
	...
	protected void method_doGenerate(final StringBuffer stringBuffer,
		...
		String operationMethodName = genModel.isRichClientPlatform() ? "run"
				: "execute";
		String _ArrayListOfObject = "ArrayList"
				+ (genModel.useGenerics() ? "<Object>" : "");
		...
		String _CollectionOfSelectionChangedListener = "Collection"
				+ (genModel.useGenerics() ? "<ISelectionChangedListener>" : "");
		String _ArrayListOfResource = "ArrayList"
				+ (genModel.useGenerics() ? "<Resource>" : "");
		String _CollectionOfResource = "Collection"
				+ (genModel.useGenerics() ? "<Resource>" : "");
		String _MapOfResourceToDiagnostic = "Map"
				+ (genModel.useGenerics() ? "<Resource, Diagnostic>" : "");
		String _HashMapOfResourceToBoolean = "HashMap"
				+ (genModel.useGenerics() ? "<Resource, Boolean>" : "");
		String _MapOfObjectToObject = "Map"
				+ (genModel.useGenerics() ? "<Object, Object>" : "");
		String _HashMapOfObjectToObject = "HashMap"
				+ (genModel.useGenerics() ? "<Object, Object>" : "");
		String _LinkedHashMapOfResourceToDiagnostic = "LinkedHashMap"
				+ (genModel.useGenerics() ? "<Resource, Diagnostic>" : "");
		String _CollectionOfAnything = "Collection"
				+ (genModel.useGenerics() ? "<?>" : "");
		String _ListOfAnything = "List" + (genModel.useGenerics() ? "<?>" : "");
		boolean useExtendedLabelProvider = genModel.isFontProviders()
		...
		if (genPackage.isExtensibleProviderFactory()) {
			...
			stringBuffer
					.append(genModel
							.getImportedName("org.polarsys.kitalpha.emde.extension.ModelExtensionListener"));
		}
		...
		if (genModel.isRichClientPlatform()) {
			...
			if (genPackage.isGenerateModelWizard()) {
				...
				stringBuffer.append(genModel
						.getImportedName("java.util.Arrays"));
		...
		stringBuffer.append(TEXT_137);
		{
			...
			callParameters.put("importedOperationClassName",
					importedOperationClassName);
			callParameters.put("operationMethodName", operationMethodName);
			callParameters.put("_ArrayListOfObject", _ArrayListOfObject);
			callParameters.put("_ArrayListOfSelectionChangedListener",
					_ArrayListOfSelectionChangedListener);
			callParameters.put("_CollectionOfSelectionChangedListener",
					_CollectionOfSelectionChangedListener);
			...
			callParameters.put("_MapOfResourceToDiagnostic",
					_MapOfResourceToDiagnostic);
			callParameters.put("_HashMapOfResourceToBoolean",
					_HashMapOfResourceToBoolean);
			callParameters.put("_MapOfObjectToObject", _MapOfObjectToObject);
			callParameters.put("_HashMapOfObjectToObject",
					_HashMapOfObjectToObject);
			callParameters.put("_LinkedHashMapOfResourceToDiagnostic",
					_LinkedHashMapOfResourceToDiagnostic);
			callParameters.put("_CollectionOfAnything", _CollectionOfAnything);
			callParameters.put("_ListOfAnything", _ListOfAnything);
			callParameters.put("useExtendedLabelProvider",
					useExtendedLabelProvider);
			callParameters.put("_AdapterFactoryLabelProvider",
					_AdapterFactoryLabelProvider);
