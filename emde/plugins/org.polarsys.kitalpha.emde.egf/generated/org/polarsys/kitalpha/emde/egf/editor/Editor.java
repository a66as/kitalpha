...
public class Editor extends org.eclipse.egf.emf.pattern.editor.Editor {
	...
	protected final String TEXT_13 = NL + "import org.eclipse.jface.viewers.TreeViewer;" + NL
			...
			+ "import org.eclipse.swt.dnd.Transfer;" + NL + "" + NL + "import org.eclipse.swt.events.ControlAdapter;"
			+ NL + "import org.eclipse.swt.events.ControlEvent;" + NL + "" + NL
	...
	protected final String TEXT_28 = NL + NL + "import org.eclipse.emf.common.ui.editor.ProblemEditorPart;" + NL + ""
	...
	protected final String TEXT_41 = " " + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */" + NL
			+ "public class ";
	...
	protected final String TEXT_43 = ", IGotoMarker";
	...
	protected final String TEXT_69 = NL + "\t/**" + NL
			...
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
			+ "\tprotected PropertySheetPage propertySheetPage;" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_83 = ".this);" + NL + "" + NL + "\t\t\t\t\t\tsetCurrentViewer(contentOutlineViewer);"
			+ NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\telse if (p instanceof PropertySheet)" + NL
			+ "\t\t\t\t{" + NL + "\t\t\t\t\tif (((PropertySheet)p).getCurrentPage() == propertySheetPage)" + NL
	...
	protected final String TEXT_106 = "();" + NL + "" + NL + "\t\t\t\t\t\tpublic boolean visit(IResourceDelta delta)"
			+ NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tif (delta.getResource().getType() == IResource.FILE)" + NL
	...
	protected final String TEXT_131 = NL + NL + "\t\t\tif (markerHelper.hasMarkers(editingDomain.getResourceSet()))"
	...
	protected final String TEXT_135 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This creates a model editor."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "\tpublic ";
	protected final String TEXT_136 = "()" + NL + "\t{" + NL + "\t\tsuper();" + NL + "\t\tinitializeEditingDomain();"
	...
	protected final String TEXT_139 = "());" + NL + "\t\t// Register this editor for ExtendedModel state" + NL
			+ "\t\t//" + NL + "\t\t";
	protected final String TEXT_140 = ".getInstance(getEditingDomain().getResourceSet()).addListener(this);\t\t" + NL
			+ "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This is here for the listener to be able to call it." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_141 = NL + "\t\t\t@Override";
	protected final String TEXT_142 = NL + "\tprotected void firePropertyChange(int action)" + NL + "\t{" + NL
	...
	protected final String TEXT_143 = " collection)" + NL + "\t{" + NL + "\t\tfinal ";
	protected final String TEXT_144 = " theSelection = collection;" + NL + "\t\t// Make sure it's okay." + NL + "\t\t//"
	...
	protected final String TEXT_146 = NL + "\t\tpublic Object [] getElements(Object object)" + NL + "\t\t{" + NL
	...
	protected final String TEXT_148 = NL + "\t\tpublic Object [] getChildren(Object object)" + NL + "\t\t{" + NL
			+ "\t\t\tObject parent = super.getParent(object);" + NL
			+ "\t\t\treturn (parent == null ? Collections.EMPTY_SET : Collections.singleton(parent)).toArray();" + NL
			+ "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL
			+ "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */";
	protected final String TEXT_149 = NL + "\t\t@Override";
	protected final String TEXT_150 = NL + "\t\tpublic boolean hasChildren(Object object)" + NL + "\t\t{" + NL
			+ "\t\t\tObject parent = super.getParent(object);" + NL + "\t\t\treturn parent != null;" + NL + "\t\t}" + NL
			+ "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL
			+ "\t\t * @generated" + NL + "\t\t */";
	protected final String TEXT_151 = NL + "\t\t@Override";
	protected final String TEXT_152 = NL + "\t\tpublic Object getParent(Object object)" + NL + "\t\t{" + NL
			+ "\t\t\treturn null;" + NL + "\t\t}" + NL + "\t}";
	protected final String TEXT_153 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
	...
	protected final String TEXT_155 = NL + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL
	...
	protected final String TEXT_156 = "> getEmdeViewerFilterActions(";
	protected final String TEXT_157 = " resource_p) {" + NL
	...
	protected final String TEXT_159 = "> extensionActions = new ";
	protected final String TEXT_160 = "<EmdeViewerFilterAction>();\t\t" + NL
			+ "\t\tString extensibleModelURI = resource_p.getContents().get(0).eClass().getEPackage().getNsURI();" + NL
			+ "\t\t";
	protected final String TEXT_161 = " helper = ";
	protected final String TEXT_162 = ".getInstance(resource_p);" + NL + "\t\t";
	protected final String TEXT_163 = " extensibleModel = ";
	protected final String TEXT_164 = ".INSTANCE.getExtensibleModel(extensibleModelURI);" + NL
			+ "\t\tif (extensibleModel != null) {\t\t" + NL + "\t\t\tfor (";
	protected final String TEXT_165 = " extendedModel : extensibleModel.getAllExtendedModels()) {" + NL + "\t\t\t\t";
	protected final String TEXT_166 = " filterAction = new EmdeViewerFilterAction(resource_p, extensibleModel, extendedModel) {"
			+ NL + "\t\t\t\t\t@Override" + NL + "\t\t\t\t\tpublic void run() {" + NL
			+ "\t\t\t\t\t\tISelection selection = getSelection();" + NL + "\t\t\t\t\t\tif (selection instanceof ";
	protected final String TEXT_167 = ") {" + NL + "\t\t\t\t\t\t\tif (selection.isEmpty() == false) {" + NL
			+ "\t\t\t\t\t\t\t\tsetSelectionToViewer(((";
	protected final String TEXT_168 = ") getSelection()).toList());" + NL + "\t\t\t\t\t\t\t} else {        " + NL
			+ "\t\t\t\t\t\t\t\tif (getResource() != null) {" + NL
			+ "\t\t\t\t\t\t\t\t\tif (getResource().getContents().isEmpty()) {" + NL
			+ "\t\t\t\t\t\t\t\t\t\tsetSelectionToViewer((new ";
	protected final String TEXT_169 = "(getResource())).toList());" + NL + "\t\t\t\t\t\t\t\t\t} else {" + NL
			+ "\t\t\t\t\t\t\t\t\t\tsetSelectionToViewer((new ";
	protected final String TEXT_170 = "(getResource().getContents().get(0))).toList());" + NL + "\t\t\t\t\t\t\t\t\t}"
			+ NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t};\t\t\t" + NL
	...
	protected final String TEXT_171 = ") getActionBarContributor());\t\t\t\t" + NL
	...
	protected final String TEXT_173 = NL + "\t\tcontextMenu.add(new Separator(\"additions\"));";
	protected final String TEXT_174 = NL + "\t\tcontextMenu.setRemoveAllWhenShown(true);" + NL
			+ "\t\tcontextMenu.addMenuListener(this);" + NL
			+ "\t\tMenu menu= contextMenu.createContextMenu(viewer.getControl());" + NL
			+ "\t\tviewer.getControl().setMenu(menu);" + NL + "" + NL
			+ "\t\tint dndOperations = DND.DROP_COPY | DND.DROP_MOVE | DND.DROP_LINK;" + NL
			+ "\t\tTransfer[] transfers = new Transfer[] { LocalTransfer.getInstance() };" + NL
	...
	protected final String TEXT_177 = NL + "\t\t// Assumes that the input is a file object." + NL + "\t\t//" + NL
			+ "\t\tIFileEditorInput modelFile = (IFileEditorInput)getEditorInput();" + NL
			+ "\t\tURI resourceURI = URI.createPlatformResourceURI(modelFile.getFile().getFullPath().toString(), true);";
	protected final String TEXT_178 = NL + "\t\tException exception = null;" + NL + "\t\tResource resource = null;" + NL
			...
			+ "\t\t";
	protected final String TEXT_179 = ".getViewpointMetadata(editingDomain.getResourceSet()).initMetadataStorage();"
			+ NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_181 = NL + "\t\t\t\t\t 0," + NL
	...
	protected final String TEXT_184 = NL + "\t\t\t\t\t 0," + NL
			+ "\t\t\t\t\t getString(\"_UI_CreateModelError_message\", resource.getURI()),";
	protected final String TEXT_185 = NL + "\t\t\t\t\t new Object[] { exception });" + NL + "\t\t}" + NL + "\t\telse"
	...
	protected final String TEXT_187 = NL + "\tpublic void createPages()" + NL + "\t{" + NL
	...
	protected final String TEXT_188 = NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	protected final String TEXT_189 = ".this)" + NL + "\t\t\t\t\t{";
	protected final String TEXT_190 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_191 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tTree tree = new Tree(composite, SWT.MULTI);";
	protected final String TEXT_192 = NL + "                            // begin-extension-code" + NL
			...
			+ "                            // end-extension-code";
	protected final String TEXT_193 = NL + "                            return new TreeViewer(tree);";
	protected final String TEXT_194 = NL + "\t\t\t\t\t\t}";
	protected final String TEXT_195 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_196 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
	...
	protected final String TEXT_197 = NL + "                // begin-extension-code" + NL
	...
	protected final String TEXT_201 = "));" + NL + "\t\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
	...
	protected final String TEXT_202 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// Create a page for the parent tree view."
	...
	protected final String TEXT_205 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\tTree tree = new Tree(composite, SWT.MULTI);";
	protected final String TEXT_206 = NL + "                            // begin-extension-code" + NL
			+ "                            TreeViewer newTreeViewer = new TreeViewer(tree) {" + NL
			+ "                                @Override" + NL
			+ "                                public void refresh() {" + NL
			+ "                                    super.refresh();" + NL
			...
			+ "                            };" + NL + "                            return newTreeViewer;" + NL
			+ "                            // end-extension-code";
	protected final String TEXT_207 = NL + "                            return new TreeViewer(tree);";
	protected final String TEXT_208 = NL + "\t\t\t\t\t\t}";
	protected final String TEXT_209 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_210 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL + ""
			+ NL + "\t\t\t\tparentViewer = (TreeViewer)viewerPane.getViewer();";
	protected final String TEXT_211 = NL + "                // begin-extension-code" + NL
			+ "                viewers.add(parentViewer);" + NL + "                // end-extension-code";
	protected final String TEXT_212 = NL + "\t\t\t\tparentViewer.setAutoExpandLevel(30);" + NL
	...
	protected final String TEXT_213 = "(adapterFactory";
	protected final String TEXT_214 = ", parentViewer";
	protected final String TEXT_215 = "));" + NL + "" + NL + "\t\t\t\tcreateContextMenuFor(parentViewer);" + NL
			+ "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
			+ "\t\t\t\tsetPageText(pageIndex, getString(\"_UI_ParentPage_label\"));";
	protected final String TEXT_216 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the list viewer"
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	...
	protected final String TEXT_219 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{";
	protected final String TEXT_220 = NL + "                            // begin-extension-code" + NL
			...
			+ "                            // end-extension-code";
	protected final String TEXT_221 = NL + "                            return new ListViewer(composite);";
	protected final String TEXT_222 = "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t}";
	protected final String TEXT_223 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_224 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL
			+ "\t\t\t\tlistViewer = (ListViewer)viewerPane.getViewer();";
	protected final String TEXT_225 = NL + "                // begin-extension-code" + NL
	...
	protected final String TEXT_233 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{";
	protected final String TEXT_234 = NL + "                            // begin-extension-code" + NL
			...
			+ "                            };" + NL + "                            return newTreeViewer;" + NL
			+ "                            // end-extension-code";
	protected final String TEXT_235 = NL + "                            return new TreeViewer(composite);";
	protected final String TEXT_236 = NL + "\t\t\t\t\t\t}";
	protected final String TEXT_237 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_238 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL
			+ "\t\t\t\ttreeViewer = (TreeViewer)viewerPane.getViewer();";
	protected final String TEXT_239 = NL + "                // begin-extension-code" + NL
	...
	protected final String TEXT_242 = ", treeViewer";
	protected final String TEXT_243 = "));" + NL + "" + NL
			+ "\t\t\t\tnew AdapterFactoryTreeEditor(treeViewer.getTree(), adapterFactory);" + NL + "" + NL
			+ "\t\t\t\tcreateContextMenuFor(treeViewer);" + NL
			+ "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
			+ "\t\t\t\tsetPageText(pageIndex, getString(\"_UI_TreePage_label\"));";
	protected final String TEXT_244 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// This is the page for the table viewer."
			+ NL + "\t\t\t//" + NL + "\t\t\t{" + NL + "\t\t\t\tViewerPane viewerPane =" + NL
			+ "\t\t\t\t\tnew ViewerPane(getSite().getPage(), ";
	protected final String TEXT_245 = ".this)" + NL + "\t\t\t\t\t{";
	protected final String TEXT_246 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_247 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{";
	protected final String TEXT_248 = NL + "                            // begin-extension-code" + NL
			...
			+ "                            // end-extension-code";
	protected final String TEXT_249 = NL + "                            return new TableViewer(composite);";
	protected final String TEXT_250 = NL + "\t\t\t\t\t\t}";
	protected final String TEXT_251 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_252 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL
			+ "\t\t\t\ttableViewer = (TableViewer)viewerPane.getViewer();";
	protected final String TEXT_253 = NL + "                // begin-extension-code" + NL
			+ "                viewers.add(tableViewer);" + NL + "                // end-extension-code";
	protected final String TEXT_254 = NL + NL + "\t\t\t\tTable table = tableViewer.getTable();" + NL
	...
	protected final String TEXT_255 = NL + "\t\t\t\tobjectColumn.setResizable(true);" + NL + "" + NL
			+ "\t\t\t\tTableColumn selfColumn = new TableColumn(table, SWT.NONE);" + NL
			+ "\t\t\t\tlayout.addColumnData(new ColumnWeightData(2, 100, true));" + NL
			+ "\t\t\t\tselfColumn.setText(getString(\"_UI_SelfColumn_label\"));";
	protected final String TEXT_256 = NL + "\t\t\t\tselfColumn.setResizable(true);" + NL + "" + NL
	...
	protected final String TEXT_258 = "(adapterFactory";
	protected final String TEXT_259 = ", tableViewer";
	protected final String TEXT_260 = "));" + NL + "" + NL + "\t\t\t\tcreateContextMenuFor(tableViewer);" + NL
			+ "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
	...
	protected final String TEXT_262 = ".this)" + NL + "\t\t\t\t\t{";
	protected final String TEXT_263 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_264 = NL + "\t\t\t\t\t\tpublic Viewer createViewer(Composite composite)" + NL
			+ "\t\t\t\t\t\t{";
	protected final String TEXT_265 = NL + "                            // begin-extension-code" + NL
			...
			+ "                            };" + NL + "                            return newTreeViewer;" + NL
			+ "                            // end-extension-code";
	protected final String TEXT_266 = NL + "                            return new TreeViewer(composite);";
	protected final String TEXT_267 = NL + "\t\t\t\t\t\t}";
	protected final String TEXT_268 = NL + "\t\t\t\t\t\t@Override";
	protected final String TEXT_269 = NL + "\t\t\t\t\t\tpublic void requestActivation()" + NL + "\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\tsuper.requestActivation();" + NL + "\t\t\t\t\t\t\tsetCurrentViewerPane(this);" + NL
			+ "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t};" + NL + "\t\t\t\tviewerPane.createControl(getContainer());" + NL + ""
	...
	protected final String TEXT_271 = NL + NL + "\t\t\t\tTree tree = treeViewerWithColumns.getTree();" + NL
			...
			+ "\t\t\t\tobjectColumn.setText(getString(\"_UI_ObjectColumn_label\"));";
	protected final String TEXT_272 = NL + "\t\t\t\tobjectColumn.setResizable(true);" + NL
			+ "\t\t\t\tobjectColumn.setWidth(250);" + NL + "" + NL
			+ "\t\t\t\tTreeColumn selfColumn = new TreeColumn(tree, SWT.NONE);" + NL
			+ "\t\t\t\tselfColumn.setText(getString(\"_UI_SelfColumn_label\"));";
	protected final String TEXT_273 = NL + "\t\t\t\tselfColumn.setResizable(true);" + NL
	...
	protected final String TEXT_277 = "));" + NL + "" + NL + "\t\t\t\tcreateContextMenuFor(treeViewerWithColumns);" + NL
			+ "\t\t\t\tint pageIndex = addPage(viewerPane.getControl());" + NL
			+ "\t\t\t\tsetPageText(pageIndex, getString(\"_UI_TreeWithColumnsPage_label\"));";
	protected final String TEXT_278 = NL + "\t\t\t}";
	protected final String TEXT_279 = NL + "\t\t\tTree tree = new Tree(getContainer(), SWT.MULTI);";
	protected final String TEXT_280 = NL + "            // begin-extension-code" + NL
			...
			+ "            // end-extension-code";
	protected final String TEXT_281 = NL + "            selectionViewer = new TreeViewer(tree);";
	protected final String TEXT_282 = "\t\t" + NL + "\t\t\tsetCurrentViewer(selectionViewer);" + NL + "" + NL
			+ "\t\t\tselectionViewer.setContentProvider(new AdapterFactoryContentProvider(adapterFactory));" + NL
			+ "\t\t\tselectionViewer.setLabelProvider(new ";
	protected final String TEXT_283 = "(adapterFactory";
	protected final String TEXT_284 = ", selectionViewer";
	protected final String TEXT_285 = "));" + NL + "\t\t\tselectionViewer.setInput(editingDomain.getResourceSet());"
			+ NL
			+ "\t\t\tselectionViewer.setSelection(new StructuredSelection(editingDomain.getResourceSet().getResources().get(0)), true);"
			+ NL + "" + NL + "\t\t\tnew AdapterFactoryTreeEditor(selectionViewer.getTree(), adapterFactory);" + NL + ""
			+ NL + "\t\t\tcreateContextMenuFor(selectionViewer);" + NL + "\t\t\tint pageIndex = addPage(tree);" + NL
			+ "\t\t\tsetPageText(pageIndex, getString(\"_UI_SelectionPage_label\"));";
	protected final String TEXT_286 = NL + NL + "\t\t\tgetSite().getShell().getDisplay().asyncExec" + NL
			+ "\t\t\t\t(new Runnable()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t public void run()" + NL + "\t\t\t\t\t {"
	...
	protected final String TEXT_288 = NL + "\t\t\t\tpublic void controlResized(ControlEvent event)" + NL + "\t\t\t\t{"
	...
	protected final String TEXT_289 = NL + "\t\t\tif (getContainer() instanceof CTabFolder)" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_290 = NL + "\t\t\tif (getContainer() instanceof CTabFolder)" + NL + "\t\t\t{" + NL
	...
	protected final String TEXT_292 = NL + "\tprotected void pageChange(int pageIndex)" + NL + "\t{" + NL
			...
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_293 = NL + "\t@SuppressWarnings(\"";
	protected final String TEXT_294 = "rawtypes";
	protected final String TEXT_295 = "unchecked";
	protected final String TEXT_296 = "\")";
	protected final String TEXT_297 = NL + "\t@Override";
	protected final String TEXT_298 = NL + "\tpublic Object getAdapter(Class key)" + NL + "\t{" + NL
	...
	protected final String TEXT_299 = NL + "\t\telse if (key.equals(IGotoMarker.class))" + NL + "\t\t{" + NL
			+ "\t\t\treturn this;" + NL + "\t\t}";
	protected final String TEXT_300 = NL + "\t\telse" + NL + "\t\t{" + NL + "\t\t\treturn super.getAdapter(key);" + NL
			+ "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_302 = NL + "\t\t\t\tpublic void createControl(Composite parent)" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tsuper.createControl(parent);" + NL + "\t\t\t\t\tcontentOutlineViewer = getTreeViewer();" + NL
			+ "\t\t\t\t\tcontentOutlineViewer.addSelectionChangedListener(this);\t\t\t\t\t";
	protected final String TEXT_303 = NL + "                    // begin-extension-code" + NL
			+ "                    viewers.add(contentOutlineViewer);" + NL
			+ "                    // end-extension-code" + NL + "\t\t\t\t\tfor (";
	protected final String TEXT_304 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\t\t\t\tfor (";
	protected final String TEXT_305 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			+ "\t\t\t\t\t\t\tfilterAction.addViewer(contentOutlineViewer);" + NL + "\t\t\t\t\t\t}" + NL
			+ "\t\t\t\t\t}  ";
	protected final String TEXT_306 = "\t\t\t\t\t\t\t\t\t\t" + NL + "" + NL + "\t\t\t\t\t// Set up the tree viewer."
			+ NL + "\t\t\t\t\t//" + NL
			+ "\t\t\t\t\tcontentOutlineViewer.setContentProvider(new AdapterFactoryContentProvider(adapterFactory));"
			+ NL + "\t\t\t\t\tcontentOutlineViewer.setLabelProvider(new ";
	protected final String TEXT_307 = "(adapterFactory";
	protected final String TEXT_308 = ", contentOutlineViewer";
	...
	protected final String TEXT_313 = NL + "\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL
	...
	protected final String TEXT_315 = NL + "\t\t\t\tpublic void dispose() {";
	protected final String TEXT_316 = NL + "                    // begin-extension-code             " + NL
			+ "                    viewers.remove(contentOutlineViewer);                   " + NL
			+ "                    // end-extension-code\t\t\t\t\t" + NL + "\t\t\t\t\tfor (";
	protected final String TEXT_317 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\t\t\t\tfor (";
	protected final String TEXT_318 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			+ "\t\t\t\t\t\t\tfilterAction.removeViewer(contentOutlineViewer);" + NL + "\t\t\t\t\t\t}" + NL
			+ "\t\t\t\t\t}";
	protected final String TEXT_319 = "\t\t\t\t\t" + NL + "\t\t\t\t\tsuper.dispose();" + NL + "\t\t\t\t}\t\t\t\t" + NL
			...
			+ "\t\tif (propertySheetPage == null)" + NL + "\t\t{" + NL + "\t\t\tpropertySheetPage =" + NL
			+ "\t\t\t\tnew ExtendedPropertySheetPage(editingDomain)" + NL + "\t\t\t\t{";
	protected final String TEXT_320 = NL + "\t\t\t\t\t@Override";
	protected final String TEXT_321 = NL + "\t\t\t\t\tpublic void setSelectionToViewer(";
	protected final String TEXT_322 = " selection)" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\t";
	protected final String TEXT_323 = ".this.setSelectionToViewer(selection);" + NL + "\t\t\t\t\t\t";
	protected final String TEXT_324 = ".this.setFocus();" + NL + "\t\t\t\t\t}" + NL;
	protected final String TEXT_325 = NL + "\t\t\t\t\t@Override";
	protected final String TEXT_326 = NL + "\t\t\t\t\tpublic void setActionBars(IActionBars actionBars)" + NL
			+ "\t\t\t\t\t{" + NL + "\t\t\t\t\t\tsuper.setActionBars(actionBars);" + NL
			+ "\t\t\t\t\t\tgetActionBarContributor().shareGlobalActions(this, actionBars);" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t};" + NL
			+ "\t\t\tpropertySheetPage.setPropertySourceProvider(new AdapterFactoryContentProvider(adapterFactory));"
			+ NL + "\t\t}" + NL + "" + NL + "\t\treturn propertySheetPage;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_329 = NL + "\t\t{" + NL + "\t\t\tIterator";
	protected final String TEXT_330 = "<?>";
	protected final String TEXT_331 = " selectedElements = ((IStructuredSelection)selection).iterator();" + NL
	...
	protected final String TEXT_332 = NL
			...
			+ "\t\t\t\t{" + NL + "\t\t\t\t\t";
	protected final String TEXT_333 = " selectionList = new ";
	protected final String TEXT_334 = "();" + NL + "\t\t\t\t\tselectionList.add(selectedElement);" + NL
	...
	protected final String TEXT_336 = " selectionList = new ";
	protected final String TEXT_337 = "();" + NL + "\t\t\t\tselectionList.add(selectedElement);" + NL
			+ "\t\t\t\twhile (selectedElements.hasNext())" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\tselectionList.add(selectedElements.next());" + NL + "\t\t\t\t}" + NL + "" + NL
			+ "\t\t\t\t// Set the selection to the widget." + NL + "\t\t\t\t//" + NL
			+ "\t\t\t\tselectionViewer.setSelection(new StructuredSelection(selectionList));";
	protected final String TEXT_338 = NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
			+ "\t * This is for implementing {@link IEditorPart} and simply tests the command stack." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_339 = NL + "\t@Override";
	protected final String TEXT_340 = NL + "\tpublic boolean isDirty()" + NL + "\t{" + NL
	...
	protected final String TEXT_342 = NL + "\tpublic void doSave(IProgressMonitor progressMonitor)" + NL + "\t{" + NL
			+ "\t\t// Save only resources that have actually changed." + NL + "\t\t//" + NL + "\t\tfinal ";
	protected final String TEXT_343 = " saveOptions = new ";
	...
	protected final String TEXT_346 = NL + NL
			...
			+ NL + "\t\t//" + NL + "\t\t";
	protected final String TEXT_347 = " operation =" + NL + "\t\t\tnew ";
	...
	protected final String TEXT_350 = NL + "\t\t\t\tpublic void ";
	protected final String TEXT_351 = "(IProgressMonitor monitor)" + NL + "\t\t\t\t{" + NL
	...
	protected final String TEXT_355 = NL + "\t\t\t\t\t\tResource resource = (Resource)i.next();";
	protected final String TEXT_356 = NL
			+ "\t\t\t\t\t\tif ((first || !resource.getContents().isEmpty() || isPersisted(resource)) && !editingDomain.isReadOnly(resource))"
			+ NL + "\t\t\t\t\t\t{" + NL + "\t\t\t\t\t\t\ttry" + NL + "\t\t\t\t\t\t\t{";
	protected final String TEXT_357 = NL + "\t\t\t\t\t\t\t\tlong timeStamp = resource.getTimeStamp();" + NL
			+ "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tif (resource.getTimeStamp() != timeStamp)" + NL + "\t\t\t\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\t\t\t\tsavedResources.add(resource);" + NL + "\t\t\t\t\t\t\t\t}";
	protected final String TEXT_358 = NL + "\t\t\t\t\t\t\t\tresource.save(saveOptions);" + NL
			+ "\t\t\t\t\t\t\t\tsavedResources.add(resource);";
	protected final String TEXT_359 = NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcatch (Exception exception)" + NL
			+ "\t\t\t\t\t\t\t{" + NL
			...
			+ NL + "\t\t\t//" + NL + "\t\t\t";
	protected final String TEXT_360 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL
	...
	protected final String TEXT_362 = NL + "\tpublic boolean isSaveAsAllowed()" + NL + "\t{" + NL + "\t\treturn true;"
			+ NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * This also changes the editor's input." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_363 = NL + "\t@Override";
	protected final String TEXT_364 = NL + "\tpublic void doSaveAs()" + NL + "\t{";
	protected final String TEXT_365 = NL + "\t\tnew ";
	protected final String TEXT_366 = "(getSite().getShell(), null, SWT.NONE)" + NL + "\t\t\t{";
	protected final String TEXT_367 = NL + "\t\t\t\t@Override";
	protected final String TEXT_368 = NL + "\t\t\t\tprotected boolean isSave()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\treturn true;" + NL + "\t\t\t\t}" + NL;
	protected final String TEXT_369 = NL + "\t\t\t\t@Override";
	protected final String TEXT_370 = NL + "\t\t\t\tprotected boolean processResources()" + NL + "\t\t\t\t{" + NL
			+ "\t\t\t\t\t";
	protected final String TEXT_371 = " uris = getURIs();" + NL + "\t\t\t\t\tif (uris.size() > 0)" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tURI uri = ";
	protected final String TEXT_372 = "uris.get(0);" + NL + "\t\t\t\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_373 = "(uri));" + NL + "\t\t\t\t\t\treturn true;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t\telse" + NL + "\t\t\t\t\t{" + NL + "\t\t\t\t\t\treturn false;" + NL + "\t\t\t\t\t}" + NL
			+ "\t\t\t\t}" + NL + "\t\t\t}.open();";
	protected final String TEXT_374 = NL + "\t\tString[] filters = ";
	protected final String TEXT_375 = "(String[])";
	protected final String TEXT_376 = "FILE_EXTENSION_FILTERS.toArray(new String[FILE_EXTENSION_FILTERS.size()]);" + NL
			+ "\t\tString[] files = ";
	protected final String TEXT_377 = ".openFilePathDialog(getSite().getShell(), ";
	protected final String TEXT_378 = ".SAVE, filters);" + NL + "\t\tif (files.length > 0)" + NL + "\t\t{" + NL
			+ "\t\t\tURI uri = URI.createFileURI(files[0]);" + NL + "\t\t\tdoSaveAs(uri, new ";
	protected final String TEXT_379 = "(uri));" + NL + "\t\t}";
	protected final String TEXT_380 = NL + "\t\tSaveAsDialog saveAsDialog = new SaveAsDialog(getSite().getShell());"
	...
	protected final String TEXT_382 = "(Resource)";
	protected final String TEXT_383 = "editingDomain.getResourceSet().getResources().get(0)).setURI(uri);" + NL
	...
	protected final String TEXT_384 = "();" + NL + "\t\tdoSave(progressMonitor);" + NL + "\t}";
	protected final String TEXT_385 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL
			...
			+ "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL
			+ "\t\tcatch (CoreException exception)" + NL + "\t\t{" + NL + "\t\t\t";
	protected final String TEXT_386 = ".INSTANCE.log(exception);" + NL + "\t\t}" + NL + "\t}";
	protected final String TEXT_387 = NL + NL + "\t/**" + NL + "\t * This is called during startup." + NL
			+ "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */";
	protected final String TEXT_388 = NL + "\t@Override";
	protected final String TEXT_389 = NL + "\tpublic void init(IEditorSite site, IEditorInput editorInput)" + NL + "\t{"
	...
	protected final String TEXT_391 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
	protected final String TEXT_392 = NL + "\t@Override";
	protected final String TEXT_393 = NL + "\tpublic void setFocus()" + NL + "\t{";
	protected final String TEXT_394 = NL + "\t\tif (currentViewerPane != null)" + NL + "\t\t{" + NL
			+ "\t\t\tcurrentViewerPane.setFocus();" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{" + NL
			+ "\t\t\tgetControl(getActivePage()).setFocus();" + NL + "\t\t}";
	protected final String TEXT_395 = NL + "\t\tgetControl(getActivePage()).setFocus();";
	protected final String TEXT_396 = NL + "\t}" + NL + "" + NL + "\t/**" + NL
			...
			+ NL;
	protected final String TEXT_397 = NL + "\t\tfor (ISelectionChangedListener listener : selectionChangedListeners)";
	...
	protected final String TEXT_402 = " collection = ((IStructuredSelection)selection).toList();" + NL
			+ "\t\t\t\tswitch (collection.size())" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\tcase 0:" + NL + "\t\t\t\t\t{"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_NoObjectSelected\"));";
	protected final String TEXT_403 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tcase 1:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tString text = new AdapterFactoryItemDelegator(adapterFactory).getText(collection.iterator().next());"
			+ NL + "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_SingleObjectSelected\", text));";
	protected final String TEXT_404 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tdefault:" + NL
			+ "\t\t\t\t\t{" + NL
			+ "\t\t\t\t\t\tstatusLineManager.setMessage(getString(\"_UI_MultiObjectSelected\", Integer.toString(collection.size())));";
	protected final String TEXT_405 = NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}"
	...
	protected final String TEXT_407 = ".INSTANCE.getString(key);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL
	...
	protected final String TEXT_408 = ".INSTANCE.getString(key, new Object [] { s1 });" + NL + "\t}" + NL + "" + NL
			+ "\t/**" + NL
	...
	protected final String TEXT_410 = NL + "\tpublic void dispose()" + NL + "\t{" + NL
	...
	protected final String TEXT_412 = NL + "\t\tgetSite().getPage().removePartListener(partListener);" + NL + "" + NL
			+ "\t\tadapterFactory.dispose();\t\t";
	protected final String TEXT_413 = NL + NL + "\t\t// Clean and dispose viewerFilterActions" + NL + "\t\tfor (";
	protected final String TEXT_414 = " resource : viewerFilterActions.keySet()) {" + NL + "\t\t\tfor (";
	protected final String TEXT_415 = " filterAction : viewerFilterActions.get(resource)) {" + NL
			+ "\t\t\t\tfilterAction.removePropertyChangeListener((";
	protected final String TEXT_416 = ") getActionBarContributor());" + NL + "\t\t\t\tfilterAction.dispose();" + NL
			+ "\t\t\t}" + NL + "\t\t}" + NL + "\t\t// Unregister this editor for ExtendedModel state" + NL + "\t\t//"
			+ NL + "\t\t";
	protected final String TEXT_417 = ".getInstance(getEditingDomain().getResourceSet()).removeListener(this);";
	protected final String TEXT_418 = "\t\t" + NL + "" + NL
			...
			+ "\t\t}" + NL + "" + NL + "\t\tif (contentOutlinePage != null)" + NL + "\t\t{" + NL
			+ "\t\t\tcontentOutlinePage.dispose();" + NL + "\t\t}" + NL + "" + NL + "\t\tsuper.dispose();" + NL + "\t}"
			+ NL + "" + NL + "\t/**" + NL + "\t * Returns whether the outline view should be presented to the user."
			+ NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
